...
_MAVRIN = {
    "He": (2, [0.0, 100.0], [[-3.5551e01, 3.1469e-01, 1.0156e-01, -9.3730e-02, 2.5020e-02]]),
    "Li": (3, [0.0, 100.0], [[-3.5115e01, 1.9475e-01, 2.5082e-01, -1.6070e-01, 3.5190e-02]]),
    "Be": (4, [0.0, 100.0], [[-3.4765e01, 3.7270e-02, 3.8363e-01, -2.1384e-01, 4.1690e-02]]),
    "C": (6, [0.0, 0.5, 100.0],
          [[-3.4738e01, -5.0085e00, -1.2788e01, -1.6637e01, -7.2904e00],
           [-3.4174e01, -3.6687e-01, 6.8856e-01, -2.9191e-01, 4.4470e-02]]),
    "N": (7, [0.0, 0.5, 2.0, 100.0],
...
def lz_total(name: str, Te_keV) -> np.ndarray:
    ...
    for i, c in enumerate(rows):
        sel = (Te >= borders[i]) & (Te <= borders[i + 1] if i == len(rows) - 1
                                    else Te < borders[i + 1])
        if np.any(sel):
