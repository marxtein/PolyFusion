...
def main():
    ...
    for name in MACHINES:
        ...
        for s in sh["sections"]:
            ...
            ok(
                "wall" in s and len(s["wall"]["R"]) == len(R),
