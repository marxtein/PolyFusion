...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1.074e+04`、`Qfus=685.4`、`Pheat=15.67`、`Pwall=6.748`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.074e+04`、`Qfus=685.4`、`Pheat=15.67`、`Pwall=6.748`、`Ptrans=1865`、`Pbrem=266.9`、`Pcycl=30.68`、`P_line=0`、`Pn=8590`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.701`、`betaT=0.1088`、`nbar_o_Sudo=0.6883`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.074e+04` 满足 `>=10`；`Qfus=685.4` 满足 `>=1`；`nbar_o_Sudo=0.6883` 满足 `<=1`；`betaT=0.1088` 不满足 `<=0.05`；`H_ISS04=1.701` 不满足 `<=1.5`。
