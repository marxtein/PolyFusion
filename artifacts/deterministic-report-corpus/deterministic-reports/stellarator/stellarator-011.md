...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=254.4`、`Qfus=0.9479`、`Pheat=268.4`、`Pwall=0.3281`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=254.4`、`Qfus=0.9479`、`Pheat=268.4`、`Pwall=0.3281`、`Ptrans=285.7`、`Pbrem=32.33`、`Pcycl=1.254`、`P_line=0`、`Pn=203.5`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.8057`、`betaT=0.01666`、`nbar_o_Sudo=0.8232`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=254.4` 满足 `>=10`；`Qfus=0.9479` 不满足 `>=1`；`nbar_o_Sudo=0.8232` 满足 `<=1`；`betaT=0.01666` 满足 `<=0.05`；`H_ISS04=0.8057` 满足 `<=1.5`。
