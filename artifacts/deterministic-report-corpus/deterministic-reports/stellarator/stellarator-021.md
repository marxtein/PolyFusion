...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1781`、`Qfus=4.157`、`Pheat=428.5`、`Pwall=1.387`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1781`、`Qfus=4.157`、`Pheat=428.5`、`Pwall=1.387`、`Ptrans=680.6`、`Pbrem=99.6`、`Pcycl=4.426`、`P_line=0`、`Pn=1425`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.086`、`betaT=0.0397`、`nbar_o_Sudo=0.834`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1781` 满足 `>=10`；`Qfus=4.157` 满足 `>=1`；`nbar_o_Sudo=0.834` 满足 `<=1`；`betaT=0.0397` 满足 `<=0.05`；`H_ISS04=1.086` 满足 `<=1.5`。
