...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=5717`、`Qfus=14.81`、`Pheat=386.1`、`Pwall=3.83`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=5717`、`Qfus=14.81`、`Pheat=386.1`、`Pwall=3.83`、`Ptrans=1361`、`Pbrem=142.1`、`Pcycl=26.21`、`P_line=0`、`Pn=4574`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.632`、`betaT=0.0794`、`nbar_o_Sudo=0.5973`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=5717` 满足 `>=10`；`Qfus=14.81` 满足 `>=1`；`nbar_o_Sudo=0.5973` 满足 `<=1`；`betaT=0.0794` 不满足 `<=0.05`；`H_ISS04=1.632` 不满足 `<=1.5`。
