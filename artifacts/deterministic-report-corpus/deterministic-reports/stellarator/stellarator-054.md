...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=9513`、`Qfus=39.74`、`Pheat=239.3`、`Pwall=6.12`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=9513`、`Qfus=39.74`、`Pheat=239.3`、`Pwall=6.12`、`Ptrans=1882`、`Pbrem=217`、`Pcycl=42.58`、`P_line=0`、`Pn=7610`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.828`、`betaT=0.1098`、`nbar_o_Sudo=0.5982`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=9513` 满足 `>=10`；`Qfus=39.74` 满足 `>=1`；`nbar_o_Sudo=0.5982` 满足 `<=1`；`betaT=0.1098` 不满足 `<=0.05`；`H_ISS04=1.828` 不满足 `<=1.5`。
