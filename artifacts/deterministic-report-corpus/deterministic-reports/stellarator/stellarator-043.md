...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2267`、`Qfus=4.713`、`Pheat=480.9`、`Pwall=1.724`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2267`、`Qfus=4.713`、`Pheat=480.9`、`Pwall=1.724`、`Ptrans=857.1`、`Pbrem=56.34`、`Pcycl=20.8`、`P_line=0`、`Pn=1813`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.551`、`betaT=0.04999`、`nbar_o_Sudo=0.4812`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2267` 满足 `>=10`；`Qfus=4.713` 满足 `>=1`；`nbar_o_Sudo=0.4812` 满足 `<=1`；`betaT=0.04999` 满足 `<=0.05`；`H_ISS04=1.551` 不满足 `<=1.5`。
