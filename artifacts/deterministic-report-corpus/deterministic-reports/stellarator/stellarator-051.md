...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2685`、`Qfus=4.835`、`Pheat=555.3`、`Pwall=2.033`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2685`、`Qfus=4.835`、`Pheat=555.3`、`Pwall=2.033`、`Ptrans=1000`、`Pbrem=61.24`、`Pcycl=31.04`、`P_line=0`、`Pn=2148`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.706`、`betaT=0.05832`、`nbar_o_Sudo=0.4451`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2685` 满足 `>=10`；`Qfus=4.835` 满足 `>=1`；`nbar_o_Sudo=0.4451` 满足 `<=1`；`betaT=0.05832` 不满足 `<=0.05`；`H_ISS04=1.706` 不满足 `<=1.5`。
