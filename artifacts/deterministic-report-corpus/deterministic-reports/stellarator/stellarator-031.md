...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=5912`、`Qfus=20.51`、`Pheat=288.2`、`Pwall=3.891`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=5912`、`Qfus=20.51`、`Pheat=288.2`、`Pwall=3.891`、`Ptrans=1244`、`Pbrem=216.1`、`Pcycl=10.8`、`P_line=0`、`Pn=4730`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.344`、`betaT=0.07254`、`nbar_o_Sudo=0.8348`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=5912` 满足 `>=10`；`Qfus=20.51` 满足 `>=1`；`nbar_o_Sudo=0.8348` 满足 `<=1`；`betaT=0.07254` 不满足 `<=0.05`；`H_ISS04=1.344` 满足 `<=1.5`。
