...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1205`、`Qfus=2.249`、`Pheat=535.8`、`Pwall=1.093`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1205`、`Qfus=2.249`、`Pheat=535.8`、`Pwall=1.093`、`Ptrans=621.8`、`Pbrem=153.1`、`Pcycl=1.851`、`P_line=0`、`Pn=964.1`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.9106`、`betaT=0.03627`、`nbar_o_Sudo=1.149`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1205` 满足 `>=10`；`Qfus=2.249` 满足 `>=1`；`nbar_o_Sudo=1.149` 不满足 `<=1`；`betaT=0.03627` 满足 `<=0.05`；`H_ISS04=0.9106` 满足 `<=1.5`。
