...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1129`、`Qfus=2.659`、`Pheat=424.7`、`Pwall=0.9753`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1129`、`Qfus=2.659`、`Pheat=424.7`、`Pwall=0.9753`、`Ptrans=605`、`Pbrem=28.07`、`Pcycl=17.47`、`P_line=0`、`Pn=903.5`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.501`、`betaT=0.03529`、`nbar_o_Sudo=0.4071`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1129` 满足 `>=10`；`Qfus=2.659` 满足 `>=1`；`nbar_o_Sudo=0.4071` 满足 `<=1`；`betaT=0.03529` 满足 `<=0.05`；`H_ISS04=1.501` 不满足 `<=1.5`。
