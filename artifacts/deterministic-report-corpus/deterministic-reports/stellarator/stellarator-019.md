...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=706.1`、`Qfus=2.137`、`Pheat=330.3`、`Pwall=0.6504`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=706.1`、`Qfus=2.137`、`Pheat=330.3`、`Pwall=0.6504`、`Ptrans=428.6`、`Pbrem=39.48`、`Pcycl=3.512`、`P_line=0`、`Pn=564.9`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.022`、`betaT=0.025`、`nbar_o_Sudo=0.6773`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=706.1` 满足 `>=10`；`Qfus=2.137` 满足 `>=1`；`nbar_o_Sudo=0.6773` 满足 `<=1`；`betaT=0.025` 满足 `<=0.05`；`H_ISS04=1.022` 满足 `<=1.5`。
