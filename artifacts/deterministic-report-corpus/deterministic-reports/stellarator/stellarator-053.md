...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=6772`、`Qfus=15.85`、`Pheat=427.3`、`Pwall=4.518`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=6772`、`Qfus=15.85`、`Pheat=427.3`、`Pwall=4.518`、`Ptrans=1588`、`Pbrem=154.5`、`Pcycl=39.11`、`P_line=0`、`Pn=5418`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.791`、`betaT=0.09263`、`nbar_o_Sudo=0.5534`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=6772` 满足 `>=10`；`Qfus=15.85` 满足 `>=1`；`nbar_o_Sudo=0.5534` 满足 `<=1`；`betaT=0.09263` 不满足 `<=0.05`；`H_ISS04=1.791` 不满足 `<=1.5`。
