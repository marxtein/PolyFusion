...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=64.31`、`Qfus=0.236`、`Pheat=272.5`、`Pwall=0.2114`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=64.31`、`Qfus=0.236`、`Pheat=272.5`、`Pwall=0.2114`、`Ptrans=226.9`、`Pbrem=58.19`、`Pcycl=0.275`、`P_line=0`、`Pn=51.45`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.586`、`betaT=0.01323`、`nbar_o_Sudo=1.383`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=64.31` 满足 `>=10`；`Qfus=0.236` 不满足 `>=1`；`nbar_o_Sudo=1.383` 不满足 `<=1`；`betaT=0.01323` 满足 `<=0.05`；`H_ISS04=0.586` 满足 `<=1.5`。
