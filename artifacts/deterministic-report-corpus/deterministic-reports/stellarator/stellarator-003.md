...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=25.49`、`Qfus=0.1583`、`Pheat=161`、`Pwall=0.1171`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=25.49`、`Qfus=0.1583`、`Pheat=161`、`Pwall=0.1171`、`Ptrans=142.9`、`Pbrem=23.07`、`Pcycl=0.2182`、`P_line=0`、`Pn=20.4`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.5409`、`betaT=0.008332`、`nbar_o_Sudo=1.141`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=25.49` 满足 `>=10`；`Qfus=0.1583` 不满足 `>=1`；`nbar_o_Sudo=1.141` 不满足 `<=1`；`betaT=0.008332` 满足 `<=0.05`；`H_ISS04=0.5409` 满足 `<=1.5`。
