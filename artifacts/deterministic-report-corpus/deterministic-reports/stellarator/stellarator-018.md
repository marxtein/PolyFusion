...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=351.8`、`Qfus=1.381`、`Pheat=254.8`、`Pwall=0.3807`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=351.8`、`Qfus=1.381`、`Pheat=254.8`、`Pwall=0.3807`、`Ptrans=302.5`、`Pbrem=19.67`、`Pcycl=2.951`、`P_line=0`、`Pn=281.5`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.9833`、`betaT=0.01764`、`nbar_o_Sudo=0.5758`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=351.8` 满足 `>=10`；`Qfus=1.381` 满足 `>=1`；`nbar_o_Sudo=0.5758` 满足 `<=1`；`betaT=0.01764` 满足 `<=0.05`；`H_ISS04=0.9833` 满足 `<=1.5`。
