...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2986`、`Qfus=6.984`、`Pheat=427.6`、`Pwall=2.142`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2986`、`Qfus=6.984`、`Pheat=427.6`、`Pwall=2.142`、`Ptrans=924.3`、`Pbrem=85.71`、`Pcycl=14.78`、`P_line=0`、`Pn=2389`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.428`、`betaT=0.05391`、`nbar_o_Sudo=0.5946`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2986` 满足 `>=10`；`Qfus=6.984` 满足 `>=1`；`nbar_o_Sudo=0.5946` 满足 `<=1`；`betaT=0.05391` 不满足 `<=0.05`；`H_ISS04=1.428` 满足 `<=1.5`。
