...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=4422`、`Qfus=12.19`、`Pheat=362.9`、`Pwall=3.003`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=4422`、`Qfus=12.19`、`Pheat=362.9`、`Pwall=3.003`、`Ptrans=1076`、`Pbrem=161.7`、`Pcycl=10.05`、`P_line=0`、`Pn=3538`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.315`、`betaT=0.06273`、`nbar_o_Sudo=0.7839`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=4422` 满足 `>=10`；`Qfus=12.19` 满足 `>=1`；`nbar_o_Sudo=0.7839` 满足 `<=1`；`betaT=0.06273` 不满足 `<=0.05`；`H_ISS04=1.315` 满足 `<=1.5`。
