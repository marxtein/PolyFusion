...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=211.6`、`Qfus=1.03`、`Pheat=205.4`、`Pwall=0.2617`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=211.6`、`Qfus=1.03`、`Pheat=205.4`、`Pwall=0.2617`、`Ptrans=235.3`、`Pbrem=7.737`、`Pcycl=4.698`、`P_line=0`、`Pn=169.3`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.114`、`betaT=0.01372`、`nbar_o_Sudo=0.3848`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=211.6` 满足 `>=10`；`Qfus=1.03` 满足 `>=1`；`nbar_o_Sudo=0.3848` 满足 `<=1`；`betaT=0.01372` 满足 `<=0.05`；`H_ISS04=1.114` 满足 `<=1.5`。
