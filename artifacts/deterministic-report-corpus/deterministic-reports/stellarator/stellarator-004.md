...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=42.7`、`Qfus=0.1984`、`Pheat=215.2`、`Pwall=0.1618`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=42.7`、`Qfus=0.1984`、`Pheat=215.2`、`Pwall=0.1618`、`Ptrans=184.9`、`Pbrem=38.63`、`Pcycl=0.2483`、`P_line=0`、`Pn=34.16`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.5643`、`betaT=0.01078`、`nbar_o_Sudo=1.273`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=42.7` 满足 `>=10`；`Qfus=0.1984` 不满足 `>=1`；`nbar_o_Sudo=1.273` 不满足 `<=1`；`betaT=0.01078` 满足 `<=0.05`；`H_ISS04=0.5643` 满足 `<=1.5`。
