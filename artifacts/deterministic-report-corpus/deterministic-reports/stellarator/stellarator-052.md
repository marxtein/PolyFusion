...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=4496`、`Qfus=8.44`、`Pheat=532.7`、`Pwall=3.156`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=4496`、`Qfus=8.44`、`Pheat=532.7`、`Pwall=3.156`、`Ptrans=1294`、`Pbrem=102.6`、`Pcycl=35.31`、`P_line=0`、`Pn=3597`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.751`、`betaT=0.07548`、`nbar_o_Sudo=0.503`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=4496` 满足 `>=10`；`Qfus=8.44` 满足 `>=1`；`nbar_o_Sudo=0.503` 满足 `<=1`；`betaT=0.07548` 不满足 `<=0.05`；`H_ISS04=1.751` 不满足 `<=1.5`。
