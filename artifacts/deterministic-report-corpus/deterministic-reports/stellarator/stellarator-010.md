...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=126.8`、`Qfus=0.6552`、`Pheat=193.5`、`Pwall=0.201`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=126.8`、`Qfus=0.6552`、`Pheat=193.5`、`Pwall=0.201`、`Ptrans=201.7`、`Pbrem=16.11`、`Pcycl=1.054`、`P_line=0`、`Pn=101.4`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.7723`、`betaT=0.01176`、`nbar_o_Sudo=0.7019`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=126.8` 满足 `>=10`；`Qfus=0.6552` 不满足 `>=1`；`nbar_o_Sudo=0.7019` 满足 `<=1`；`betaT=0.01176` 满足 `<=0.05`；`H_ISS04=0.7723` 满足 `<=1.5`。
