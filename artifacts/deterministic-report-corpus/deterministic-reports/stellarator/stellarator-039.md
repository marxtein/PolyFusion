...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=8446`、`Qfus=66.57`、`Pheat=126.9`、`Pwall=5.38`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=8446`、`Qfus=66.57`、`Pheat=126.9`、`Pwall=5.38`、`Ptrans=1555`、`Pbrem=242.4`、`Pcycl=19.16`、`P_line=0`、`Pn=6757`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.529`、`betaT=0.09067`、`nbar_o_Sudo=0.7512`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=8446` 满足 `>=10`；`Qfus=66.57` 满足 `>=1`；`nbar_o_Sudo=0.7512` 满足 `<=1`；`betaT=0.09067` 不满足 `<=0.05`；`H_ISS04=1.529` 不满足 `<=1.5`。
