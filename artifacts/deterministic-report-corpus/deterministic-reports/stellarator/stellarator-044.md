...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=3796`、`Qfus=8.111`、`Pheat=468`、`Pwall=2.676`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=3796`、`Qfus=8.111`、`Pheat=468`、`Pwall=2.676`、`Ptrans=1109`、`Pbrem=94.36`、`Pcycl=23.66`、`P_line=0`、`Pn=3037`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.594`、`betaT=0.0647`、`nbar_o_Sudo=0.5434`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=3796` 满足 `>=10`；`Qfus=8.111` 满足 `>=1`；`nbar_o_Sudo=0.5434` 满足 `<=1`；`betaT=0.0647` 不满足 `<=0.05`；`H_ISS04=1.594` 不满足 `<=1.5`。
