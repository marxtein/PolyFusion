...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=384.3`、`Qfus=1.285`、`Pheat=299`、`Pwall=0.4288`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=384.3`、`Qfus=1.285`、`Pheat=299`、`Pwall=0.4288`、`Ptrans=352.9`、`Pbrem=9.553`、`Pcycl=13.35`、`P_line=0`、`Pn=307.4`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.437`、`betaT=0.02058`、`nbar_o_Sudo=0.3124`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=384.3` 满足 `>=10`；`Qfus=1.285` 满足 `>=1`；`nbar_o_Sudo=0.3124` 满足 `<=1`；`betaT=0.02058` 满足 `<=0.05`；`H_ISS04=1.437` 满足 `<=1.5`。
