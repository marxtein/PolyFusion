...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=90.33`、`Qfus=0.2714`、`Pheat=332.9`、`Pwall=0.2656`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=90.33`、`Qfus=0.2714`、`Pheat=332.9`、`Pwall=0.2656`、`Ptrans=268.9`、`Pbrem=81.73`、`Pcycl=0.2994`、`P_line=0`、`Pn=72.27`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.6066`、`betaT=0.01568`、`nbar_o_Sudo=1.478`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=90.33` 满足 `>=10`；`Qfus=0.2714` 不满足 `>=1`；`nbar_o_Sudo=1.478` 不满足 `<=1`；`betaT=0.01568` 满足 `<=0.05`；`H_ISS04=0.6066` 满足 `<=1.5`。
