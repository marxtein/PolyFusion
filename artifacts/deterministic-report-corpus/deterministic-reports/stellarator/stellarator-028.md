...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2090`、`Qfus=5.146`、`Pheat=406.2`、`Pwall=1.567`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2090`、`Qfus=5.146`、`Pheat=406.2`、`Pwall=1.567`、`Ptrans=739.5`、`Pbrem=76.42`、`Pcycl=8.329`、`P_line=0`、`Pn=1672`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.25`、`betaT=0.04313`、`nbar_o_Sudo=0.663`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2090` 满足 `>=10`；`Qfus=5.146` 满足 `>=1`；`nbar_o_Sudo=0.663` 满足 `<=1`；`betaT=0.04313` 满足 `<=0.05`；`H_ISS04=1.25` 满足 `<=1.5`。
