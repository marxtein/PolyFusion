...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=4.323`、`Qfus=0.06971`、`Pheat=62.01`、`Pwall=0.04163`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=4.323`、`Qfus=0.06971`、`Pheat=62.01`、`Pwall=0.04163`、`Ptrans=58.82`、`Pbrem=3.911`、`Pcycl=0.14`、`P_line=0`、`Pn=3.458`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.4828`、`betaT=0.003431`、`nbar_o_Sudo=0.7638`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=4.323` 不满足 `>=10`；`Qfus=0.06971` 不满足 `>=1`；`nbar_o_Sudo=0.7638` 满足 `<=1`；`betaT=0.003431` 满足 `<=0.05`；`H_ISS04=0.4828` 满足 `<=1.5`。
