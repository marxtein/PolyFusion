...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=7662`、`Qfus=15.19`、`Pheat=504.4`、`Pwall=5.125`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=7662`、`Qfus=15.19`、`Pheat=504.4`、`Pwall=5.125`、`Ptrans=1815`、`Pbrem=166.3`、`Pcycl=55.42`、`P_line=0`、`Pn=6130`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.944`、`betaT=0.1059`、`nbar_o_Sudo=0.5176`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=7662` 满足 `>=10`；`Qfus=15.19` 满足 `>=1`；`nbar_o_Sudo=0.5176` 满足 `<=1`；`betaT=0.1059` 不满足 `<=0.05`；`H_ISS04=1.944` 不满足 `<=1.5`。
