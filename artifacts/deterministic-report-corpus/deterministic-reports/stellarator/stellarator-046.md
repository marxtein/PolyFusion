...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=8031`、`Qfus=34.13`、`Pheat=235.3`、`Pwall=5.188`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=8031`、`Qfus=34.13`、`Pheat=235.3`、`Pwall=5.188`、`Ptrans=1613`、`Pbrem=199.6`、`Pcycl=28.54`、`P_line=0`、`Pn=6425`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.667`、`betaT=0.0941`、`nbar_o_Sudo=0.6452`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=8031` 满足 `>=10`；`Qfus=34.13` 满足 `>=1`；`nbar_o_Sudo=0.6452` 满足 `<=1`；`betaT=0.0941` 不满足 `<=0.05`；`H_ISS04=1.667` 不满足 `<=1.5`。
