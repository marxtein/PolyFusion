...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1783`、`Qfus=4.227`、`Pheat=421.8`、`Pwall=1.384`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1783`、`Qfus=4.227`、`Pheat=421.8`、`Pwall=1.384`、`Ptrans=714.3`、`Pbrem=51.18`、`Pcycl=12.99`、`P_line=0`、`Pn=1426`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.388`、`betaT=0.04166`、`nbar_o_Sudo=0.5272`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1783` 满足 `>=10`；`Qfus=4.227` 满足 `>=1`；`nbar_o_Sudo=0.5272` 满足 `<=1`；`betaT=0.04166` 满足 `<=0.05`；`H_ISS04=1.388` 满足 `<=1.5`。
