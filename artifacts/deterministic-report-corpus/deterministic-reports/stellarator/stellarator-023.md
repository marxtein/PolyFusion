...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=3345`、`Qfus=7.335`、`Pheat=456`、`Pwall=2.385`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=3345`、`Qfus=7.335`、`Pheat=456`、`Pwall=2.385`、`Ptrans=932.7`、`Pbrem=187`、`Pcycl=5.181`、`P_line=0`、`Pn=2676`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.141`、`betaT=0.0544`、`nbar_o_Sudo=0.9545`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=3345` 满足 `>=10`；`Qfus=7.335` 满足 `>=1`；`nbar_o_Sudo=0.9545` 满足 `<=1`；`betaT=0.0544` 不满足 `<=0.05`；`H_ISS04=1.141` 满足 `<=1.5`。
