...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=515`、`Qfus=1.266`、`Pheat=407`、`Pwall=0.5786`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=515`、`Qfus=1.266`、`Pheat=407`、`Pwall=0.5786`、`Ptrans=470.6`、`Pbrem=11.18`、`Pcycl=28.22`、`P_line=0`、`Pn=412`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.731`、`betaT=0.02745`、`nbar_o_Sudo=0.2682`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=515` 满足 `>=10`；`Qfus=1.266` 满足 `>=1`；`nbar_o_Sudo=0.2682` 满足 `<=1`；`betaT=0.02745` 满足 `<=0.05`；`H_ISS04=1.731` 不满足 `<=1.5`。
