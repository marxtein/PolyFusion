...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=6318`、`Qfus=22.56`、`Pheat=280.1`、`Pwall=4.141`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=6318`、`Qfus=22.56`、`Pheat=280.1`、`Pwall=4.141`、`Ptrans=1344`、`Pbrem=181.3`、`Pcycl=17.82`、`P_line=0`、`Pn=5054`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.497`、`betaT=0.07842`、`nbar_o_Sudo=0.7047`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=6318` 满足 `>=10`；`Qfus=22.56` 满足 `>=1`；`nbar_o_Sudo=0.7047` 满足 `<=1`；`betaT=0.07842` 不满足 `<=0.05`；`H_ISS04=1.497` 满足 `<=1.5`。
