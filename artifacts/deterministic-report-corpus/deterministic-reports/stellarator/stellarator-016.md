...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1553`、`Qfus=2.612`、`Pheat=594.6`、`Pwall=1.348`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1553`、`Qfus=2.612`、`Pheat=594.6`、`Pwall=1.348`、`Ptrans=705.9`、`Pbrem=197.3`、`Pcycl=1.972`、`P_line=0`、`Pn=1242`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.9335`、`betaT=0.04117`、`nbar_o_Sudo=1.208`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1553` 满足 `>=10`；`Qfus=2.612` 满足 `>=1`；`nbar_o_Sudo=1.208` 不满足 `<=1`；`betaT=0.04117` 满足 `<=0.05`；`H_ISS04=0.9335` 满足 `<=1.5`。
