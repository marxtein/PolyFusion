...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=4498`、`Qfus=11.83`、`Pheat=380.3`、`Pwall=3.061`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=4498`、`Qfus=11.83`、`Pheat=380.3`、`Pwall=3.061`、`Ptrans=1134`、`Pbrem=129.1`、`Pcycl=16.37`、`P_line=0`、`Pn=3598`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.464`、`betaT=0.06617`、`nbar_o_Sudo=0.653`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=4498` 满足 `>=10`；`Qfus=11.83` 满足 `>=1`；`nbar_o_Sudo=0.653` 满足 `<=1`；`betaT=0.06617` 不满足 `<=0.05`；`H_ISS04=1.464` 满足 `<=1.5`。
