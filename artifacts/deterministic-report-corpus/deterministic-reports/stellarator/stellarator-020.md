...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1182`、`Qfus=3.046`、`Pheat=388.2`、`Pwall=0.9857`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1182`、`Qfus=3.046`、`Pheat=388.2`、`Pwall=0.9857`、`Ptrans=554.6`、`Pbrem=66.12`、`Pcycl=3.995`、`P_line=0`、`Pn=946`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.056`、`betaT=0.03235`、`nbar_o_Sudo=0.7616`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1182` 满足 `>=10`；`Qfus=3.046` 满足 `>=1`；`nbar_o_Sudo=0.7616` 满足 `<=1`；`betaT=0.03235` 满足 `<=0.05`；`H_ISS04=1.056` 满足 `<=1.5`。
