...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=12.7`、`Qfus=0.1155`、`Pheat=110`、`Pwall=0.07699`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=12.7`、`Qfus=0.1155`、`Pheat=110`、`Pwall=0.07699`、`Ptrans=100.8`、`Pbrem=11.49`、`Pcycl=0.1833`、`P_line=0`、`Pn=10.16`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.5147`、`betaT=0.005881`、`nbar_o_Sudo=0.9788`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=12.7` 满足 `>=10`；`Qfus=0.1155` 不满足 `>=1`；`nbar_o_Sudo=0.9788` 满足 `<=1`；`betaT=0.005881` 满足 `<=0.05`；`H_ISS04=0.5147` 满足 `<=1.5`。
