...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=5087`、`Qfus=8.179`、`Pheat=622`、`Pwall=3.583`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=5087`、`Qfus=8.179`、`Pheat=622`、`Pwall=3.583`、`Ptrans=1479`、`Pbrem=110.4`、`Pcycl=50.02`、`P_line=0`、`Pn=4070`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.902`、`betaT=0.08626`、`nbar_o_Sudo=0.4701`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=5087` 满足 `>=10`；`Qfus=8.179` 满足 `>=1`；`nbar_o_Sudo=0.4701` 满足 `<=1`；`betaT=0.08626` 不满足 `<=0.05`；`H_ISS04=1.902` 不满足 `<=1.5`。
