...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=888.4`、`Qfus=2.448`、`Pheat=362.9`、`Pwall=0.7853`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=888.4`、`Qfus=2.448`、`Pheat=362.9`、`Pwall=0.7853`、`Ptrans=504.2`、`Pbrem=25.5`、`Pcycl=10.91`、`P_line=0`、`Pn=710.8`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.341`、`betaT=0.02941`、`nbar_o_Sudo=0.4465`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=888.4` 满足 `>=10`；`Qfus=2.448` 满足 `>=1`；`nbar_o_Sudo=0.4465` 满足 `<=1`；`betaT=0.02941` 满足 `<=0.05`；`H_ISS04=1.341` 满足 `<=1.5`。
