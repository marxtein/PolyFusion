...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1.076e+04`、`Qfus=36.78`、`Pheat=292.6`、`Pwall=6.938`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.076e+04`、`Qfus=36.78`、`Pheat=292.6`、`Pwall=6.938`、`Ptrans=2151`、`Pbrem=233.7`、`Pcycl=60.33`、`P_line=0`、`Pn=8610`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.982`、`betaT=0.1255`、`nbar_o_Sudo=0.5599`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.076e+04` 满足 `>=10`；`Qfus=36.78` 满足 `>=1`；`nbar_o_Sudo=0.5599` 满足 `<=1`；`betaT=0.1255` 不满足 `<=0.05`；`H_ISS04=1.982` 不满足 `<=1.5`。
