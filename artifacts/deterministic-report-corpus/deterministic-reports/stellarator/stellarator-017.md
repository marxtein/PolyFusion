...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=119.7`、`Qfus=0.7414`、`Pheat=161.5`、`Pwall=0.1765`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=119.7`、`Qfus=0.7414`、`Pheat=161.5`、`Pwall=0.1765`、`Ptrans=176.5`、`Pbrem=6.694`、`Pcycl=2.253`、`P_line=0`、`Pn=95.77`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.9338`、`betaT=0.01029`、`nbar_o_Sudo=0.4448`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=119.7` 满足 `>=10`；`Qfus=0.7414` 不满足 `>=1`；`nbar_o_Sudo=0.4448` 满足 `<=1`；`betaT=0.01029` 满足 `<=0.05`；`H_ISS04=0.9338` 满足 `<=1.5`。
