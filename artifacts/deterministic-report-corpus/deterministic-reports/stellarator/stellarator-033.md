...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=302.3`、`Qfus=1.206`、`Pheat=250.7`、`Pwall=0.347`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=302.3`、`Qfus=1.206`、`Pheat=250.7`、`Pwall=0.347`、`Ptrans=294.1`、`Pbrem=8.678`、`Pcycl=8.334`、`P_line=0`、`Pn=241.9`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.281`、`betaT=0.01715`、`nbar_o_Sudo=0.3434`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=302.3` 满足 `>=10`；`Qfus=1.206` 满足 `>=1`；`nbar_o_Sudo=0.3434` 满足 `<=1`；`betaT=0.01715` 满足 `<=0.05`；`H_ISS04=1.281` 满足 `<=1.5`。
