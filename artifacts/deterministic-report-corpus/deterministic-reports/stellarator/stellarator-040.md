...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=1.088e+04`、`Qfus=1000`、`Pheat=-79.25`、`Pwall=6.78`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.088e+04`、`Qfus=1000`、`Pheat=-79.25`、`Pwall=6.78`、`Ptrans=1765`、`Pbrem=312.4`、`Pcycl=20.41`、`P_line=0`、`Pn=8707`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.559`、`betaT=0.1029`、`nbar_o_Sudo=0.7935`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.088e+04` 满足 `>=10`；`Qfus=1000` 满足 `>=1`；`nbar_o_Sudo=0.7935` 满足 `<=1`；`betaT=0.1029` 不满足 `<=0.05`；`H_ISS04=1.559` 不满足 `<=1.5`。
