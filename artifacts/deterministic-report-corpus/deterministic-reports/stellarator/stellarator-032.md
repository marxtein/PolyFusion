...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=7618`、`Qfus=42.75`、`Pheat=178.2`、`Pwall=4.892`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=7618`、`Qfus=42.75`、`Pheat=178.2`、`Pwall=4.892`、`Ptrans=1412`、`Pbrem=278.5`、`Pcycl=11.51`、`P_line=0`、`Pn=6094`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.372`、`betaT=0.08234`、`nbar_o_Sudo=0.8809`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=7618` 满足 `>=10`；`Qfus=42.75` 满足 `>=1`；`nbar_o_Sudo=0.8809` 满足 `<=1`；`betaT=0.08234` 不满足 `<=0.05`；`H_ISS04=1.372` 满足 `<=1.5`。
