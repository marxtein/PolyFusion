...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1338`、`Qfus=2.703`、`Pheat=494.9`、`Pwall=1.15`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1338`、`Qfus=2.703`、`Pheat=494.9`、`Pwall=1.15`、`Ptrans=705.9`、`Pbrem=30.51`、`Pcycl=26.07`、`P_line=0`、`Pn=1070`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.654`、`betaT=0.04117`、`nbar_o_Sudo=0.376`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1338` 满足 `>=10`；`Qfus=2.703` 满足 `>=1`；`nbar_o_Sudo=0.376` 满足 `<=1`；`betaT=0.04117` 满足 `<=0.05`；`H_ISS04=1.654` 不满足 `<=1.5`。
