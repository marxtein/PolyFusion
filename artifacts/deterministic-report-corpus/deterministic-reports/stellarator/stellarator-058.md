...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1514`、`Qfus=2.638`、`Pheat=573.8`、`Pwall=1.31`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1514`、`Qfus=2.638`、`Pheat=573.8`、`Pwall=1.31`、`Ptrans=806.7`、`Pbrem=32.86`、`Pcycl=36.94`、`P_line=0`、`Pn=1211`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.8`、`betaT=0.04705`、`nbar_o_Sudo=0.3507`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1514` 满足 `>=10`；`Qfus=2.638` 满足 `>=1`；`nbar_o_Sudo=0.3507` 满足 `<=1`；`betaT=0.04705` 满足 `<=0.05`；`H_ISS04=1.8` 不满足 `<=1.5`。
