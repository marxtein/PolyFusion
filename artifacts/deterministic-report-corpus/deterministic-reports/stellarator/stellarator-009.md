...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=43.13`、`Qfus=0.3741`、`Pheat=115.3`、`Pwall=0.09943`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=43.13`、`Qfus=0.3741`、`Pheat=115.3`、`Pwall=0.09943`、`Ptrans=117.6`、`Pbrem=5.481`、`Pcycl=0.805`、`P_line=0`、`Pn=34.51`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.7304`、`betaT=0.006862`、`nbar_o_Sudo=0.544`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=43.13` 满足 `>=10`；`Qfus=0.3741` 不满足 `>=1`；`nbar_o_Sudo=0.544` 满足 `<=1`；`betaT=0.006862` 满足 `<=0.05`；`H_ISS04=0.7304` 满足 `<=1.5`。
