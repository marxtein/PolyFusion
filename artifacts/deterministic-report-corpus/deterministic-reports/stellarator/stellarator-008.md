...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=155.6`、`Qfus=0.3361`、`Pheat=462.9`、`Pwall=0.3882`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=155.6`、`Qfus=0.3361`、`Pheat=462.9`、`Pwall=0.3882`、`Ptrans=352.9`、`Pbrem=140.8`、`Pcycl=0.343`、`P_line=0`、`Pn=124.5`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.6452`、`betaT=0.02058`、`nbar_o_Sudo=1.635`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=155.6` 满足 `>=10`；`Qfus=0.3361` 不满足 `>=1`；`nbar_o_Sudo=1.635` 不满足 `<=1`；`betaT=0.02058` 满足 `<=0.05`；`H_ISS04=0.6452` 满足 `<=1.5`。
