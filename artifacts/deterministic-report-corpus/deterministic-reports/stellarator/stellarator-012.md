...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=426.1`、`Qfus=1.253`、`Pheat=340.1`、`Pwall=0.4808`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=426.1`、`Qfus=1.253`、`Pheat=340.1`、`Pwall=0.4808`、`Ptrans=369.7`、`Pbrem=54.14`、`Pcycl=1.427`、`P_line=0`、`Pn=340.9`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.835`、`betaT=0.02157`、`nbar_o_Sudo=0.923`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=426.1` 满足 `>=10`；`Qfus=1.253` 满足 `>=1`；`nbar_o_Sudo=0.923` 满足 `<=1`；`betaT=0.02157` 满足 `<=0.05`；`H_ISS04=0.835` 满足 `<=1.5`。
