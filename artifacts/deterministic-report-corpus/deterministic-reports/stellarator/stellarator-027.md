...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1248`、`Qfus=3.33`、`Pheat=374.8`、`Pwall=1.018`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1248`、`Qfus=3.33`、`Pheat=374.8`、`Pwall=1.018`、`Ptrans=571.4`、`Pbrem=45.63`、`Pcycl=7.322`、`P_line=0`、`Pn=998.4`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.213`、`betaT=0.03333`、`nbar_o_Sudo=0.5886`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1248` 满足 `>=10`；`Qfus=3.33` 满足 `>=1`；`nbar_o_Sudo=0.5886` 满足 `<=1`；`betaT=0.03333` 满足 `<=0.05`；`H_ISS04=1.213` 满足 `<=1.5`。
