...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=901.4`、`Qfus=1.903`、`Pheat=473.8`、`Pwall=0.863`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=901.4`、`Qfus=1.903`、`Pheat=473.8`、`Pwall=0.863`、`Ptrans=537.8`、`Pbrem=114.5`、`Pcycl=1.721`、`P_line=0`、`Pn=721.1`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=0.8868`、`betaT=0.03137`、`nbar_o_Sudo=1.083`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=901.4` 满足 `>=10`；`Qfus=1.903` 满足 `>=1`；`nbar_o_Sudo=1.083` 不满足 `<=1`；`betaT=0.03137` 满足 `<=0.05`；`H_ISS04=0.8868` 满足 `<=1.5`。
