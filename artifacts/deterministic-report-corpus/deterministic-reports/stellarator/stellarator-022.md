...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2502`、`Qfus=5.547`、`Pheat=451`、`Pwall=1.853`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2502`、`Qfus=5.547`、`Pheat=451`、`Pwall=1.853`、`Ptrans=806.7`、`Pbrem=139.9`、`Pcycl=4.818`、`P_line=0`、`Pn=2001`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.115`、`betaT=0.04705`、`nbar_o_Sudo=0.8976`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2502` 满足 `>=10`；`Qfus=5.547` 满足 `>=1`；`nbar_o_Sudo=0.8976` 满足 `<=1`；`betaT=0.04705` 满足 `<=0.05`；`H_ISS04=1.115` 满足 `<=1.5`。
