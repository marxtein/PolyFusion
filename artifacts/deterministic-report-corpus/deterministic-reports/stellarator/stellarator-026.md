...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=621.9`、`Qfus=2.02`、`Pheat=307.9`、`Pwall=0.5834`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=621.9`、`Qfus=2.02`、`Pheat=307.9`、`Pwall=0.5834`、`Ptrans=403.3`、`Pbrem=22.74`、`Pcycl=6.152`、`P_line=0`、`Pn=497.5`。
- 约束、成分与几何：`tauE_used=1`、`Zeff=1.867`、`Vp=1149`、`Sw=1593`。
- 仿星器 Stellarator 专属指标：`H_ISS04=1.17`、`betaT=0.02353`、`nbar_o_Sudo=0.4994`、`iota=0.8221`、`aspect_vol=10.01`。
- 当前点对默认 best 准则的逐项核对：`Pfus=621.9` 满足 `>=10`；`Qfus=2.02` 满足 `>=1`；`nbar_o_Sudo=0.4994` 满足 `<=1`；`betaT=0.02353` 满足 `<=0.05`；`H_ISS04=1.17` 满足 `<=1.5`。
