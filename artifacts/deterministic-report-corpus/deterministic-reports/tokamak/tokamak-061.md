...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1.319e+04`、`Qfus=2.068`、`Pheat=6379`、`Pwall=26.61`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.319e+04`、`Qfus=2.068`、`Pheat=6379`、`Pwall=26.61`、`Ptrans=4547`、`Pbrem=718.6`、`Pcycl=3751`、`P_line=0`、`Pn=1.055e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=9.173`、`H_ITPA20=11.37`、`betaN=43.15`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.859`、`LH_ratio=35.4`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.319e+04` 满足 `>=10`；`Qfus=2.068` 满足 `>=1`；`nbar_o_nGw=1.859` 不满足 `<=1`；`Pheat=6379` 不满足 `<=100`。
