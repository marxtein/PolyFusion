...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=2.826e+04`、`Qfus=1000`、`Pheat=-3310`、`Pwall=33.92`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2.826e+04`、`Qfus=1000`、`Pheat=-3310`、`Pwall=33.92`、`Ptrans=1663`、`Pbrem=597`、`Pcycl=82.27`、`P_line=0`、`Pn=2.261e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=2.984`、`H_ITPA20=4.446`、`betaN=15.78`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.974`、`LH_ratio=9.241`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2.826e+04` 满足 `>=10`；`Qfus=1000` 满足 `>=1`；`nbar_o_nGw=2.974` 不满足 `<=1`；`Pheat=-3310` 满足 `<=100`。
