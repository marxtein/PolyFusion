...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=441.6`、`Qfus=2.795`、`Pheat=158`、`Pwall=0.8152`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=441.6`、`Qfus=2.795`、`Pheat=158`、`Pwall=0.8152`、`Ptrans=207.9`、`Pbrem=9.327`、`Pcycl=29.09`、`P_line=0`、`Pn=353.2`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=1.48`、`H_ITPA20=1.424`、`betaN=1.973`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=0.3718`、`LH_ratio=5.131`。
- 当前点对默认 best 准则的逐项核对：`Pfus=441.6` 满足 `>=10`；`Qfus=2.795` 满足 `>=1`；`nbar_o_nGw=0.3718` 满足 `<=1`；`Pheat=158` 不满足 `<=100`。
