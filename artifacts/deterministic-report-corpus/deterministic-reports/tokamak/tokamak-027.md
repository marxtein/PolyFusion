...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=5222`、`Qfus=6.543`、`Pheat=798.1`、`Pwall=8.186`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=5222`、`Qfus=6.543`、`Pheat=798.1`、`Pwall=8.186`、`Ptrans=1325`、`Pbrem=137`、`Pcycl=380.3`、`P_line=0`、`Pn=4178`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=3.781`、`H_ITPA20=4.413`、`betaN=12.58`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.115`、`LH_ratio=14.88`。
- 当前点对默认 best 准则的逐项核对：`Pfus=5222` 满足 `>=10`；`Qfus=6.543` 满足 `>=1`；`nbar_o_nGw=1.115` 不满足 `<=1`；`Pheat=798.1` 不满足 `<=100`。
