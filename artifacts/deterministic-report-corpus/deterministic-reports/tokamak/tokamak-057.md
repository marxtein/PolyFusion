...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=527.7`、`Qfus=0.2102`、`Pheat=2510`、`Pwall=4.131`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=527.7`、`Qfus=0.2102`、`Pheat=2510`、`Pwall=4.131`、`Ptrans=909.5`、`Pbrem=28.74`、`Pcycl=1678`、`P_line=0`、`Pn=422.2`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=7.555`、`H_ITPA20=6.521`、`betaN=8.631`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=0.3718`、`LH_ratio=22.45`。
- 当前点对默认 best 准则的逐项核对：`Pfus=527.7` 满足 `>=10`；`Qfus=0.2102` 不满足 `>=1`；`nbar_o_nGw=0.3718` 满足 `<=1`；`Pheat=2510` 不满足 `<=100`。
