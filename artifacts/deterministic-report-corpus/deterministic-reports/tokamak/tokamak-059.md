...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=4749`、`Qfus=0.9608`、`Pheat=4943`、`Pwall=13.18`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=4749`、`Qfus=0.9608`、`Pheat=4943`、`Pwall=13.18`、`Ptrans=2728`、`Pbrem=258.7`、`Pcycl=2906`、`P_line=0`、`Pn=3799`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=8.433`、`H_ITPA20=9.33`、`betaN=25.89`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.115`、`LH_ratio=30.63`。
- 当前点对默认 best 准则的逐项核对：`Pfus=4749` 满足 `>=10`；`Qfus=0.9608` 不满足 `>=1`；`nbar_o_nGw=1.115` 不满足 `<=1`；`Pheat=4943` 不满足 `<=100`。
...
- 当前点未满足默认 best 准则中的：`Qfus`、`nbar_o_nGw`、`Pheat`。
