...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=4931`、`Qfus=1.381`、`Pheat=3572`、`Pwall=11.56`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=4931`、`Qfus=1.381`、`Pheat=3572`、`Pwall=11.56`、`Ptrans=2378`、`Pbrem=225.3`、`Pcycl=1955`、`P_line=0`、`Pn=3945`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=7.063`、`H_ITPA20=7.908`、`betaN=22.56`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.115`、`LH_ratio=26.69`。
- 当前点对默认 best 准则的逐项核对：`Pfus=4931` 满足 `>=10`；`Qfus=1.381` 满足 `>=1`；`nbar_o_nGw=1.115` 不满足 `<=1`；`Pheat=3572` 不满足 `<=100`。
