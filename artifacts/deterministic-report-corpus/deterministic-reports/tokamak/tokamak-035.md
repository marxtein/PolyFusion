...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=5219`、`Qfus=3.422`、`Pheat=1525`、`Pwall=9.169`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=5219`、`Qfus=3.422`、`Pheat=1525`、`Pwall=9.169`、`Ptrans=1676`、`Pbrem=164.6`、`Pcycl=728`、`P_line=0`、`Pn=4175`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=4.755`、`H_ITPA20=5.466`、`betaN=15.91`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.115`、`LH_ratio=18.82`。
- 当前点对默认 best 准则的逐项核对：`Pfus=5219` 满足 `>=10`；`Qfus=3.422` 满足 `>=1`；`nbar_o_nGw=1.115` 不满足 `<=1`；`Pheat=1525` 不满足 `<=100`。
