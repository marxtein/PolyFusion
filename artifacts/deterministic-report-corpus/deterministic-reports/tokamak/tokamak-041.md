...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=566.5`、`Qfus=0.4356`、`Pheat=1300`、`Pwall=2.539`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=566.5`、`Qfus=0.4356`、`Pheat=1300`、`Pwall=2.539`、`Ptrans=675.6`、`Pbrem=21.55`、`Pcycl=716.6`、`P_line=0`、`Pn=453.2`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=4.941`、`H_ITPA20=4.387`、`betaN=6.412`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=0.3718`、`LH_ratio=16.67`。
- 当前点对默认 best 准则的逐项核对：`Pfus=566.5` 满足 `>=10`；`Qfus=0.4356` 不满足 `>=1`；`nbar_o_nGw=0.3718` 满足 `<=1`；`Pheat=1300` 不满足 `<=100`。
