...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=163.6`、`Qfus=2.419`、`Pheat=67.62`、`Pwall=0.3144`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=163.6`、`Qfus=2.419`、`Pheat=67.62`、`Pwall=0.3144`、`Ptrans=90.95`、`Pbrem=5.981`、`Pcycl=3.412`、`P_line=0`、`Pn=130.9`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=0.7963`、`H_ITPA20=0.7986`、`betaN=0.8631`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=0.3718`、`LH_ratio=2.245`。
- 当前点对默认 best 准则的逐项核对：`Pfus=163.6` 满足 `>=10`；`Qfus=2.419` 满足 `>=1`；`nbar_o_nGw=0.3718` 满足 `<=1`；`Pheat=67.62` 满足 `<=100`。
