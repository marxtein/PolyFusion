...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=547.9`、`Qfus=0.2983`、`Pheat=1837`、`Pwall=3.242`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=547.9`、`Qfus=0.2983`、`Pheat=1837`、`Pwall=3.242`、`Ptrans=792.5`、`Pbrem=25.03`、`Pcycl=1129`、`P_line=0`、`Pn=438.3`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=6.161`、`H_ITPA20=5.39`、`betaN=7.521`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=0.3718`、`LH_ratio=19.56`。
- 当前点对默认 best 准则的逐项核对：`Pfus=547.9` 满足 `>=10`；`Qfus=0.2983` 不满足 `>=1`；`nbar_o_nGw=0.3718` 满足 `<=1`；`Pheat=1837` 不满足 `<=100`。
