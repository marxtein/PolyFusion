...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2192`、`Qfus=0.7709`、`Pheat=2843`、`Pwall=6.846`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2192`、`Qfus=0.7709`、`Pheat=2843`、`Pwall=6.846`、`Ptrans=1585`、`Pbrem=100.1`、`Pcycl=1596`、`P_line=0`、`Pn=1753`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=6.649`、`H_ITPA20=6.801`、`betaN=15.04`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=0.7435`、`LH_ratio=23.8`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2192` 满足 `>=10`；`Qfus=0.7709` 不满足 `>=1`；`nbar_o_nGw=0.7435` 满足 `<=1`；`Pheat=2843` 不满足 `<=100`。
