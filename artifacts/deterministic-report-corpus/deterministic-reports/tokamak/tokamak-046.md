...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2.039e+04`、`Qfus=8.138`、`Pheat=2506`、`Pwall=31.14`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2.039e+04`、`Qfus=8.138`、`Pheat=2506`、`Pwall=31.14`、`Ptrans=4054`、`Pbrem=776`、`Pcycl=1755`、`P_line=0`、`Pn=1.632e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=6.852`、`H_ITPA20=9.032`、`betaN=38.47`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.231`、`LH_ratio=27.69`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2.039e+04` 满足 `>=10`；`Qfus=8.138` 满足 `>=1`；`nbar_o_nGw=2.231` 不满足 `<=1`；`Pheat=2506` 不满足 `<=100`。
