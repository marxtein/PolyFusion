...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1.45e+04`、`Qfus=11.23`、`Pheat=1291`、`Pwall=21.47`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.45e+04`、`Qfus=11.23`、`Pheat=1291`、`Pwall=21.47`、`Ptrans=2793`、`Pbrem=457.3`、`Pcycl=939.8`、`P_line=0`、`Pn=1.16e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=5.406`、`H_ITPA20=6.938`、`betaN=26.51`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.859`、`LH_ratio=21.74`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.45e+04` 满足 `>=10`；`Qfus=11.23` 满足 `>=1`；`nbar_o_nGw=1.859` 不满足 `<=1`；`Pheat=1291` 不满足 `<=100`。
