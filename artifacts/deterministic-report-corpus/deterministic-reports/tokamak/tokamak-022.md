...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=1.978e+04`、`Qfus=1000`、`Pheat=-1331`、`Pwall=25.08`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.978e+04`、`Qfus=1000`、`Pheat=-1331`、`Pwall=25.08`、`Ptrans=1949`、`Pbrem=441.9`、`Pcycl=233.4`、`P_line=0`、`Pn=1.582e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=3.632`、`H_ITPA20=4.994`、`betaN=18.49`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.231`、`LH_ratio=13.31`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.978e+04` 满足 `>=10`；`Qfus=1000` 满足 `>=1`；`nbar_o_nGw=2.231` 不满足 `<=1`；`Pheat=-1331` 满足 `<=100`。
