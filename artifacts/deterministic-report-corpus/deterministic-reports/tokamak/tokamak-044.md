...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=9064`、`Qfus=3.398`、`Pheat=2668`、`Pwall=15.95`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=9064`、`Qfus=3.398`、`Pheat=2668`、`Pwall=15.95`、`Ptrans=2702`、`Pbrem=344.9`、`Pcycl=1433`、`P_line=0`、`Pn=7251`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=6.204`、`H_ITPA20=7.491`、`betaN=25.65`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.487`、`LH_ratio=24.68`。
- 当前点对默认 best 准则的逐项核对：`Pfus=9064` 满足 `>=10`；`Qfus=3.398` 满足 `>=1`；`nbar_o_nGw=1.487` 不满足 `<=1`；`Pheat=2668` 不满足 `<=100`。
