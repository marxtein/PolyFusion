...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1.973e+04`、`Qfus=4.407`、`Pheat=4476`、`Pwall=32.91`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.973e+04`、`Qfus=4.407`、`Pheat=4476`、`Pwall=32.91`、`Ptrans=4755`、`Pbrem=901.2`、`Pcycl=2765`、`P_line=0`、`Pn=1.578e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=8.12`、`H_ITPA20=10.58`、`betaN=45.13`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.231`、`LH_ratio=32.48`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.973e+04` 满足 `>=10`；`Qfus=4.407` 满足 `>=1`；`nbar_o_nGw=2.231` 不满足 `<=1`；`Pheat=4476` 不满足 `<=100`。
