...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2197`、`Qfus=5.577`、`Pheat=394`、`Pwall=3.523`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2197`、`Qfus=5.577`、`Pheat=394`、`Pwall=3.523`、`Ptrans=649.6`、`Pbrem=49.1`、`Pcycl=134.7`、`P_line=0`、`Pn=1758`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=2.583`、`H_ITPA20=2.814`、`betaN=6.165`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=0.7435`、`LH_ratio=9.754`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2197` 满足 `>=10`；`Qfus=5.577` 满足 `>=1`；`nbar_o_nGw=0.7435` 满足 `<=1`；`Pheat=394` 不满足 `<=100`。
