...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1472`、`Qfus=38.62`、`Pheat=38.12`、`Pwall=2.054`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1472`、`Qfus=38.62`、`Pheat=38.12`、`Pwall=2.054`、`Ptrans=272.8`、`Pbrem=53.83`、`Pcycl=5.909`、`P_line=0`、`Pn=1178`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=1.16`、`H_ITPA20=1.465`、`betaN=2.589`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.115`、`LH_ratio=3.063`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1472` 满足 `>=10`；`Qfus=38.62` 满足 `>=1`；`nbar_o_nGw=1.115` 不满足 `<=1`；`Pheat=38.12` 满足 `<=100`。
