...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=9278`、`Qfus=6.135`、`Pheat=1512`、`Pwall=14.67`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=9278`、`Qfus=6.135`、`Pheat=1512`、`Pwall=14.67`、`Ptrans=2235`、`Pbrem=292.7`、`Pcycl=840.6`、`P_line=0`、`Pn=7422`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=5.095`、`H_ITPA20=6.233`、`betaN=21.21`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.487`、`LH_ratio=20.41`。
- 当前点对默认 best 准则的逐项核对：`Pfus=9278` 满足 `>=10`；`Qfus=6.135` 满足 `>=1`；`nbar_o_nGw=1.487` 不满足 `<=1`；`Pheat=1512` 不满足 `<=100`。
