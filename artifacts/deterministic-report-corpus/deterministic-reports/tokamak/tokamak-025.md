...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=580.3`、`Qfus=1.035`、`Pheat=560.5`、`Pwall=1.551`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=580.3`、`Qfus=1.035`、`Pheat=560.5`、`Pwall=1.551`、`Ptrans=441.7`、`Pbrem=15.22`、`Pcycl=219.6`、`P_line=0`、`Pn=464.2`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=2.972`、`H_ITPA20=2.73`、`betaN=4.192`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=0.3718`、`LH_ratio=10.9`。
- 当前点对默认 best 准则的逐项核对：`Pfus=580.3` 满足 `>=10`；`Qfus=1.035` 满足 `>=1`；`nbar_o_nGw=0.3718` 满足 `<=1`；`Pheat=560.5` 不满足 `<=100`。
