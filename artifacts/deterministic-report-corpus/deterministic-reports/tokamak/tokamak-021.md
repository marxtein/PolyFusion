...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=1.373e+04`、`Qfus=1000`、`Pheat=-602.6`、`Pwall=17.85`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.373e+04`、`Qfus=1000`、`Pheat=-602.6`、`Pwall=17.85`、`Ptrans=1624`、`Pbrem=306.9`、`Pcycl=213.1`、`P_line=0`、`Pn=1.099e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=3.404`、`H_ITPA20=4.506`、`betaN=15.41`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.859`、`LH_ratio=12.64`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.373e+04` 满足 `>=10`；`Qfus=1000` 满足 `>=1`；`nbar_o_nGw=1.859` 不满足 `<=1`；`Pheat=-602.6` 满足 `<=100`。
