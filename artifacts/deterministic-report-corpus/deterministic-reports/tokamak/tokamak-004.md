...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=2617`、`Qfus=1000`、`Pheat=-57.17`、`Pwall=3.481`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2617`、`Qfus=1000`、`Pheat=-57.17`、`Pwall=3.481`、`Ptrans=363.8`、`Pbrem=95.7`、`Pcycl=6.824`、`P_line=0`、`Pn=2094`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=1.302`、`H_ITPA20=1.745`、`betaN=3.452`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.487`、`LH_ratio=3.323`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2617` 满足 `>=10`；`Qfus=1000` 满足 `>=1`；`nbar_o_nGw=1.487` 不满足 `<=1`；`Pheat=-57.17` 满足 `<=100`。
