...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=3.714e+04`、`Qfus=1000`、`Pheat=-2298`、`Pwall=47.37`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=3.714e+04`、`Qfus=1000`、`Pheat=-2298`、`Pwall=47.37`、`Ptrans=3534`、`Pbrem=974.1`、`Pcycl=621.1`、`P_line=0`、`Pn=2.971e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=5.126`、`H_ITPA20=7.365`、`betaN=33.54`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.974`、`LH_ratio=19.64`。
- 当前点对默认 best 准则的逐项核对：`Pfus=3.714e+04` 满足 `>=10`；`Qfus=1000` 满足 `>=1`；`nbar_o_nGw=2.974` 不满足 `<=1`；`Pheat=-2298` 满足 `<=100`。
