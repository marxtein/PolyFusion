...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=4090`、`Qfus=1000`、`Pheat=-206.1`、`Pwall=5.281`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=4090`、`Qfus=1000`、`Pheat=-206.1`、`Pwall=5.281`、`Ptrans=454.7`、`Pbrem=149.5`、`Pcycl=7.629`、`P_line=0`、`Pn=3272`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=1.433`、`H_ITPA20=2.01`、`betaN=4.315`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.859`、`LH_ratio=3.54`。
- 当前点对默认 best 准则的逐项核对：`Pfus=4090` 满足 `>=10`；`Qfus=1000` 满足 `>=1`；`nbar_o_nGw=1.859` 不满足 `<=1`；`Pheat=-206.1` 满足 `<=100`。
