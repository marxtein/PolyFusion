...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=8016`、`Qfus=1000`、`Pheat=-664.4`、`Pwall=9.996`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=8016`、`Qfus=1000`、`Pheat=-664.4`、`Pwall=9.996`、`Ptrans=636.6`、`Pbrem=293.1`、`Pcycl=9.027`、`P_line=0`、`Pn=6413`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=1.677`、`H_ITPA20=2.517`、`betaN=6.042`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.602`、`LH_ratio=3.893`。
- 当前点对默认 best 准则的逐项核对：`Pfus=8016` 满足 `>=10`；`Qfus=1000` 满足 `>=1`；`nbar_o_nGw=2.602` 不满足 `<=1`；`Pheat=-664.4` 满足 `<=100`。
