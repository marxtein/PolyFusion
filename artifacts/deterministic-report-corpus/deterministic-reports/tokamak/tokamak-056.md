...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=3.507e+04`、`Qfus=8.509`、`Pheat=4121`、`Pwall=53.29`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=3.507e+04`、`Qfus=8.509`、`Pheat=4121`、`Pwall=53.29`、`Ptrans=6340`、`Pbrem=1602`、`Pcycl=3192`、`P_line=0`、`Pn=2.805e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=8.75`、`H_ITPA20=12.13`、`betaN=60.17`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.974`、`LH_ratio=35.23`。
- 当前点对默认 best 准则的逐项核对：`Pfus=3.507e+04` 满足 `>=10`；`Qfus=8.509` 满足 `>=1`；`nbar_o_nGw=2.974` 不满足 `<=1`；`Pheat=4121` 不满足 `<=100`。
