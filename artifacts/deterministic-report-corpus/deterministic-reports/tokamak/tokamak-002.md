...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=654.4`、`Qfus=8.203`、`Pheat=79.77`、`Pwall=0.9982`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=654.4`、`Qfus=8.203`、`Pheat=79.77`、`Pwall=0.9982`、`Ptrans=181.9`、`Pbrem=23.92`、`Pcycl=4.825`、`P_line=0`、`Pn=523.5`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=0.9998`、`H_ITPA20=1.16`、`betaN=1.726`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=0.7435`、`LH_ratio=2.731`。
- 当前点对默认 best 准则的逐项核对：`Pfus=654.4` 满足 `>=10`；`Qfus=8.203` 满足 `>=1`；`nbar_o_nGw=0.7435` 满足 `<=1`；`Pheat=79.77` 满足 `<=100`。
