...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=5889`、`Qfus=1000`、`Pheat=-408.5`、`Pwall=7.452`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=5889`、`Qfus=1000`、`Pheat=-408.5`、`Pwall=7.452`、`Ptrans=545.7`、`Pbrem=215.3`、`Pcycl=8.357`、`P_line=0`、`Pn=4711`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=1.558`、`H_ITPA20=2.266`、`betaN=5.179`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.231`、`LH_ratio=3.727`。
- 当前点对默认 best 准则的逐项核对：`Pfus=5889` 满足 `>=10`；`Qfus=1000` 满足 `>=1`；`nbar_o_nGw=2.231` 不满足 `<=1`；`Pheat=-408.5` 满足 `<=100`。
