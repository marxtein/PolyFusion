...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1.416e+04`、`Qfus=5.271`、`Pheat=2687`、`Pwall=22.91`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.416e+04`、`Qfus=5.271`、`Pheat=2687`、`Pwall=22.91`、`Ptrans=3378`、`Pbrem=538.9`、`Pcycl=1602`、`P_line=0`、`Pn=1.133e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=6.537`、`H_ITPA20=8.285`、`betaN=32.06`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.859`、`LH_ratio=26.29`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.416e+04` 满足 `>=10`；`Qfus=5.271` 满足 `>=1`；`nbar_o_nGw=1.859` 不满足 `<=1`；`Pheat=2687` 不满足 `<=100`。
