...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=9284`、`Qfus=15.66`、`Pheat=592.9`、`Pwall=13.43`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=9284`、`Qfus=15.66`、`Pheat=592.9`、`Pwall=13.43`、`Ptrans=1767`、`Pbrem=243.5`、`Pcycl=439.2`、`P_line=0`、`Pn=7427`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=4.09`、`H_ITPA20=5.077`、`betaN=16.77`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.487`、`LH_ratio=16.14`。
- 当前点对默认 best 准则的逐项核对：`Pfus=9284` 满足 `>=10`；`Qfus=15.66` 满足 `>=1`；`nbar_o_nGw=1.487` 不满足 `<=1`；`Pheat=592.9` 不满足 `<=100`。
