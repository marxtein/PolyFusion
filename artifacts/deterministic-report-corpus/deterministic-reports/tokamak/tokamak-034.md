...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2319`、`Qfus=1.756`、`Pheat=1321`、`Pwall=4.95`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2319`、`Qfus=1.756`、`Pheat=1321`、`Pwall=4.95`、`Ptrans=1117`、`Pbrem=73.17`、`Pcycl=594.4`、`P_line=0`、`Pn=1856`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=4.368`、`H_ITPA20=4.595`、`betaN=10.6`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=0.7435`、`LH_ratio=16.78`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2319` 满足 `>=10`；`Qfus=1.756` 满足 `>=1`；`nbar_o_nGw=0.7435` 满足 `<=1`；`Pheat=1321` 不满足 `<=100`。
