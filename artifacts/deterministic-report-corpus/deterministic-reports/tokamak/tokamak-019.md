...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=4944`、`Qfus=18.93`、`Pheat=261.2`、`Pwall=7.077`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=4944`、`Qfus=18.93`、`Pheat=261.2`、`Pwall=7.077`、`Ptrans=974.4`、`Pbrem=110.5`、`Pcycl=165`、`P_line=0`、`Pn=3955`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=2.893`、`H_ITPA20=3.437`、`betaN=9.247`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.115`、`LH_ratio=10.94`。
- 当前点对默认 best 准则的逐项核对：`Pfus=4944` 满足 `>=10`；`Qfus=18.93` 满足 `>=1`；`nbar_o_nGw=1.115` 不满足 `<=1`；`Pheat=261.2` 不满足 `<=100`。
