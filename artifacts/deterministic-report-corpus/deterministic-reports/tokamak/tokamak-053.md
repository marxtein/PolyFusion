...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1.37e+04`、`Qfus=3.133`、`Pheat=4373`、`Pwall=24.57`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.37e+04`、`Qfus=3.133`、`Pheat=4373`、`Pwall=24.57`、`Ptrans=3963`、`Pbrem=625.8`、`Pcycl=2524`、`P_line=0`、`Pn=1.096e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=7.787`、`H_ITPA20=9.755`、`betaN=37.61`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.859`、`LH_ratio=30.84`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.37e+04` 满足 `>=10`；`Qfus=3.133` 满足 `>=1`；`nbar_o_nGw=1.859` 不满足 `<=1`；`Pheat=4373` 不满足 `<=100`。
