...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=3.377e+04`、`Qfus=4.753`、`Pheat=7106`、`Pwall=55.58`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=3.377e+04`、`Qfus=4.753`、`Pheat=7106`、`Pwall=55.58`、`Ptrans=7276`、`Pbrem=1840`、`Pcycl=4745`、`P_line=0`、`Pn=2.702e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=10.18`、`H_ITPA20=13.97`、`betaN=69.05`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.974`、`LH_ratio=40.43`。
- 当前点对默认 best 准则的逐项核对：`Pfus=3.377e+04` 满足 `>=10`；`Qfus=4.753` 满足 `>=1`；`nbar_o_nGw=2.974` 不满足 `<=1`；`Pheat=7106` 不满足 `<=100`。
