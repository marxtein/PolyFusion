...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=8443`、`Qfus=1.465`、`Pheat=5765`、`Pwall=19.32`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=8443`、`Qfus=1.465`、`Pheat=5765`、`Pwall=19.32`、`Ptrans=3638`、`Pbrem=459.9`、`Pcycl=3355`、`P_line=0`、`Pn=6754`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=8.814`、`H_ITPA20=10.4`、`betaN=34.52`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.487`、`LH_ratio=33.23`。
- 当前点对默认 best 准则的逐项核对：`Pfus=8443` 满足 `>=10`；`Qfus=1.465` 满足 `>=1`；`nbar_o_nGw=1.487` 不满足 `<=1`；`Pheat=5765` 不满足 `<=100`。
