...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=8789`、`Qfus=1000`、`Pheat=-71.63`、`Pwall=11.85`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=8789`、`Qfus=1000`、`Pheat=-71.63`、`Pwall=11.85`、`Ptrans=1299`、`Pbrem=196.4`、`Pcycl=190.6`、`P_line=0`、`Pn=7031`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=3.161`、`H_ITPA20=3.992`、`betaN=12.33`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.487`、`LH_ratio=11.87`。
- 当前点对默认 best 准则的逐项核对：`Pfus=8789` 满足 `>=10`；`Qfus=1000` 满足 `>=1`；`nbar_o_nGw=1.487` 不满足 `<=1`；`Pheat=-71.63` 满足 `<=100`。
