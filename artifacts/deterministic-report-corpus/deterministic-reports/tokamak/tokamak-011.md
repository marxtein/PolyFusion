...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=3974`、`Qfus=1000`、`Pheat=-36.84`、`Pwall=5.353`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=3974`、`Qfus=1000`、`Pheat=-36.84`、`Pwall=5.353`、`Ptrans=623.6`、`Pbrem=83.95`、`Pcycl=50.38`、`P_line=0`、`Pn=3179`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=2.048`、`H_ITPA20=2.491`、`betaN=5.918`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.115`、`LH_ratio=7.001`。
- 当前点对默认 best 准则的逐项核对：`Pfus=3974` 满足 `>=10`；`Qfus=1000` 满足 `>=1`；`nbar_o_nGw=1.115` 不满足 `<=1`；`Pheat=-36.84` 满足 `<=100`。
