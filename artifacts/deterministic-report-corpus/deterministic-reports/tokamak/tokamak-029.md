...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1.451e+04`、`Qfus=81.05`、`Pheat=179`、`Pwall=19.97`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.451e+04`、`Qfus=81.05`、`Pheat=179`、`Pwall=19.97`、`Ptrans=2209`、`Pbrem=380.5`、`Pcycl=491`、`P_line=0`、`Pn=1.161e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=4.371`、`H_ITPA20=5.691`、`betaN=20.96`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.859`、`LH_ratio=17.19`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.451e+04` 满足 `>=10`；`Qfus=81.05` 满足 `>=1`；`nbar_o_nGw=1.859` 不满足 `<=1`；`Pheat=179` 不满足 `<=100`。
