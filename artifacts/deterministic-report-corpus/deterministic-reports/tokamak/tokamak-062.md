...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1.9e+04`、`Qfus=2.793`、`Pheat=6802`、`Pwall=35.08`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.9e+04`、`Qfus=2.793`、`Pheat=6802`、`Pwall=35.08`、`Ptrans=5457`、`Pbrem=1035`、`Pcycl=4110`、`P_line=0`、`Pn=1.52e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=9.518`、`H_ITPA20=12.27`、`betaN=51.79`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.231`、`LH_ratio=37.27`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.9e+04` 满足 `>=10`；`Qfus=2.793` 满足 `>=1`；`nbar_o_nGw=2.231` 不满足 `<=1`；`Pheat=6802` 不满足 `<=100`。
