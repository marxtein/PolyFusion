...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=579.9`、`Qfus=0.658`、`Pheat=881.3`、`Pwall=1.987`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=579.9`、`Qfus=0.658`、`Pheat=881.3`、`Pwall=1.987`、`Ptrans=558.7`、`Pbrem=18.29`、`Pcycl=420.3`、`P_line=0`、`Pn=463.9`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=3.884`、`H_ITPA20=3.504`、`betaN=5.302`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=0.3718`、`LH_ratio=13.79`。
- 当前点对默认 best 准则的逐项核对：`Pfus=579.9` 满足 `>=10`；`Qfus=0.658` 不满足 `>=1`；`nbar_o_nGw=0.3718` 满足 `<=1`；`Pheat=881.3` 不满足 `<=100`。
