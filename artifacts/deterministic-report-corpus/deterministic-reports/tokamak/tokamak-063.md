...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2.586e+04`、`Qfus=3.672`、`Pheat=7042`、`Pwall=44.73`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2.586e+04`、`Qfus=3.672`、`Pheat=7042`、`Pwall=44.73`、`Ptrans=6366`、`Pbrem=1408`、`Pcycl=4439`、`P_line=0`、`Pn=2.069e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=9.852`、`H_ITPA20=13.14`、`betaN=60.42`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.602`、`LH_ratio=38.93`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2.586e+04` 满足 `>=10`；`Qfus=3.672` 满足 `>=1`；`nbar_o_nGw=2.602` 不满足 `<=1`；`Pheat=7042` 不满足 `<=100`。
