...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2.088e+04`、`Qfus=24.13`、`Pheat=865`、`Pwall=29.56`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2.088e+04`、`Qfus=24.13`、`Pheat=865`、`Pwall=29.56`、`Ptrans=3352`、`Pbrem=658.6`、`Pcycl=1029`、`P_line=0`、`Pn=1.67e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=5.698`、`H_ITPA20=7.604`、`betaN=31.81`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.231`、`LH_ratio=22.89`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2.088e+04` 满足 `>=10`；`Qfus=24.13` 满足 `>=1`；`nbar_o_nGw=2.231` 不满足 `<=1`；`Pheat=865` 不满足 `<=100`。
