...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2.841e+04`、`Qfus=120.2`、`Pheat=236.4`、`Pwall=38.96`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2.841e+04`、`Qfus=120.2`、`Pheat=236.4`、`Pwall=38.96`、`Ptrans=3911`、`Pbrem=896.4`、`Pcycl=1112`、`P_line=0`、`Pn=2.273e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=5.976`、`H_ITPA20=8.24`、`betaN=37.11`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.602`、`LH_ratio=23.92`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2.841e+04` 满足 `>=10`；`Qfus=120.2` 满足 `>=1`；`nbar_o_nGw=2.602` 不满足 `<=1`；`Pheat=236.4` 不满足 `<=100`。
...
- 当前点未满足默认 best 准则中的：`nbar_o_nGw`、`Pheat`。
