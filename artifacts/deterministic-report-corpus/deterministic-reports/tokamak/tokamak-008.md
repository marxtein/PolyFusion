...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=1.047e+04`、`Qfus=1000`、`Pheat=-973.9`、`Pwall=12.91`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.047e+04`、`Qfus=1000`、`Pheat=-973.9`、`Pwall=12.91`、`Ptrans=727.6`、`Pbrem=382.8`、`Pcycl=9.65`、`P_line=0`、`Pn=8376`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=1.794`、`H_ITPA20=2.764`、`betaN=6.905`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.974`、`LH_ratio=4.043`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.047e+04` 满足 `>=10`；`Qfus=1000` 满足 `>=1`；`nbar_o_nGw=2.974` 不满足 `<=1`；`Pheat=-973.9` 满足 `<=100`。
