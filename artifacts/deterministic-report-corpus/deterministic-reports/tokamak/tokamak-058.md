...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2111`、`Qfus=0.5434`、`Pheat=3884`、`Pwall=8.152`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2111`、`Qfus=0.5434`、`Pheat=3884`、`Pwall=8.152`、`Ptrans=1819`、`Pbrem=115`、`Pcycl=2373`、`P_line=0`、`Pn=1689`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=8.021`、`H_ITPA20=8.102`、`betaN=17.26`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=0.7435`、`LH_ratio=27.31`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2111` 满足 `>=10`；`Qfus=0.5434` 不满足 `>=1`；`nbar_o_nGw=0.7435` 满足 `<=1`；`Pheat=3884` 不满足 `<=100`。
