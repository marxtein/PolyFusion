...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2.776e+04`、`Qfus=13.03`、`Pheat=2130`、`Pwall=40.64`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2.776e+04`、`Qfus=13.03`、`Pheat=2130`、`Pwall=40.64`、`Ptrans=4729`、`Pbrem=1056`、`Pcycl=1896`、`P_line=0`、`Pn=2.221e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=7.154`、`H_ITPA20=9.746`、`betaN=44.88`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.602`、`LH_ratio=28.92`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2.776e+04` 满足 `>=10`；`Qfus=13.03` 满足 `>=1`；`nbar_o_nGw=2.602` 不满足 `<=1`；`Pheat=2130` 不满足 `<=100`。
