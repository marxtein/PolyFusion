...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2266`、`Qfus=1.134`、`Pheat=1998`、`Pwall=5.797`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2266`、`Qfus=1.134`、`Pheat=1998`、`Pwall=5.797`、`Ptrans=1351`、`Pbrem=86.22`、`Pcycl=1013`、`P_line=0`、`Pn=1813`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=5.436`、`H_ITPA20=5.636`、`betaN=12.82`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=0.7435`、`LH_ratio=20.29`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2266` 满足 `>=10`；`Qfus=1.134` 满足 `>=1`；`nbar_o_nGw=0.7435` 满足 `<=1`；`Pheat=1998` 不满足 `<=100`。
