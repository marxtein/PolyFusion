...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=3.711e+04`、`Qfus=1000`、`Pheat=-593.4`、`Pwall=49.65`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=3.711e+04`、`Qfus=1000`、`Pheat=-593.4`、`Pwall=49.65`、`Ptrans=4469`、`Pbrem=1171`、`Pcycl=1189`、`P_line=0`、`Pn=2.969e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=6.245`、`H_ITPA20=8.856`、`betaN=42.41`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.974`、`LH_ratio=24.84`。
- 当前点对默认 best 准则的逐项核对：`Pfus=3.711e+04` 满足 `>=10`；`Qfus=1000` 满足 `>=1`；`nbar_o_nGw=2.974` 不满足 `<=1`；`Pheat=-593.4` 满足 `<=100`。
