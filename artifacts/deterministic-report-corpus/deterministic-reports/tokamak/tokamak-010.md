...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1766`、`Qfus=12.53`、`Pheat=141`、`Pwall=2.593`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1766`、`Qfus=12.53`、`Pheat=141`、`Pwall=2.593`、`Ptrans=415.8`、`Pbrem=37.31`、`Pcycl=41.13`、`P_line=0`、`Pn=1413`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=1.801`、`H_ITPA20=2.01`、`betaN=3.946`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=0.7435`、`LH_ratio=6.242`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1766` 满足 `>=10`；`Qfus=12.53` 满足 `>=1`；`nbar_o_nGw=0.7435` 满足 `<=1`；`Pheat=141` 不满足 `<=100`。
