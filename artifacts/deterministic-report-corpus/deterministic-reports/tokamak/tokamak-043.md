...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=5098`、`Qfus=2.088`、`Pheat=2442`、`Pwall=10.25`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=5098`、`Qfus=2.088`、`Pheat=2442`、`Pwall=10.25`、`Ptrans=2027`、`Pbrem=194`、`Pcycl=1241`、`P_line=0`、`Pn=4079`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=5.842`、`H_ITPA20=6.624`、`betaN=19.23`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.115`、`LH_ratio=22.75`。
- 当前点对默认 best 准则的逐项核对：`Pfus=5098` 满足 `>=10`；`Qfus=2.088` 满足 `>=1`；`nbar_o_nGw=1.115` 不满足 `<=1`；`Pheat=2442` 不满足 `<=100`。
