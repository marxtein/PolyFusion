...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=1.104e+04`、`Qfus=1000`、`Pheat=-870.2`、`Pwall=13.83`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.104e+04`、`Qfus=1000`、`Pheat=-870.2`、`Pwall=13.83`、`Ptrans=1039`、`Pbrem=233.2`、`Pcycl=65.04`、`P_line=0`、`Pn=8831`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=2.459`、`H_ITPA20=3.326`、`betaN=9.864`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.859`、`LH_ratio=8.09`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.104e+04` 满足 `>=10`；`Qfus=1000` 满足 `>=1`；`nbar_o_nGw=1.859` 不满足 `<=1`；`Pheat=-870.2` 满足 `<=100`。
