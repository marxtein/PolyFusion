...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=549.3`、`Qfus=1.703`、`Pheat=322.5`、`Pwall=1.185`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=549.3`、`Qfus=1.703`、`Pheat=322.5`、`Pwall=1.185`、`Ptrans=324.8`、`Pbrem=12.28`、`Pcycl=95.28`、`P_line=0`、`Pn=439.5`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=2.182`、`H_ITPA20=2.046`、`betaN=3.082`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=0.3718`、`LH_ratio=8.016`。
- 当前点对默认 best 准则的逐项核对：`Pfus=549.3` 满足 `>=10`；`Qfus=1.703` 满足 `>=1`；`nbar_o_nGw=0.3718` 满足 `<=1`；`Pheat=322.5` 不满足 `<=100`。
