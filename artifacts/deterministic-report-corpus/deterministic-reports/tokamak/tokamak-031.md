...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=2.843e+04`、`Qfus=1000`、`Pheat=-1267`、`Pwall=36.94`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2.843e+04`、`Qfus=1000`、`Pheat=-1267`、`Pwall=36.94`、`Ptrans=3092`、`Pbrem=745.8`、`Pcycl=581`、`P_line=0`、`Pn=2.275e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=4.885`、`H_ITPA20=6.826`、`betaN=29.35`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.602`、`LH_ratio=18.91`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2.843e+04` 满足 `>=10`；`Qfus=1000` 满足 `>=1`；`nbar_o_nGw=2.602` 不满足 `<=1`；`Pheat=-1267` 满足 `<=100`。
