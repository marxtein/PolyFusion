...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=3.626e+04`、`Qfus=23.24`、`Pheat=1560`、`Pwall=51.42`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=3.626e+04`、`Qfus=23.24`、`Pheat=1560`、`Pwall=51.42`、`Ptrans=5405`、`Pbrem=1379`、`Pcycl=2027`、`P_line=0`、`Pn=2.9e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=7.445`、`H_ITPA20=10.44`、`betaN=51.29`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.974`、`LH_ratio=30.03`。
- 当前点对默认 best 准则的逐项核对：`Pfus=3.626e+04` 满足 `>=10`；`Qfus=23.24` 满足 `>=1`；`nbar_o_nGw=2.974` 不满足 `<=1`；`Pheat=1560` 不满足 `<=100`。
