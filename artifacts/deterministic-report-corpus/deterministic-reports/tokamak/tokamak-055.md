...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2.685e+04`、`Qfus=6.115`、`Pheat=4391`、`Pwall=42.48`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2.685e+04`、`Qfus=6.115`、`Pheat=4391`、`Pwall=42.48`、`Ptrans=5548`、`Pbrem=1227`、`Pcycl=2986`、`P_line=0`、`Pn=2.148e+04`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=8.44`、`H_ITPA20=11.37`、`betaN=52.65`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=2.602`、`LH_ratio=33.93`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2.685e+04` 满足 `>=10`；`Qfus=6.115` 满足 `>=1`；`nbar_o_nGw=2.602` 不满足 `<=1`；`Pheat=4391` 不满足 `<=100`。
