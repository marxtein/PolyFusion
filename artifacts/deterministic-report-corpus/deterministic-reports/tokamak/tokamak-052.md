...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=8767`、`Qfus=2.152`、`Pheat=4075`、`Pwall=17.46`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=8767`、`Qfus=2.152`、`Pheat=4075`、`Pwall=17.46`、`Ptrans=3170`、`Pbrem=400.5`、`Pcycl=2257`、`P_line=0`、`Pn=7013`。
- 约束、成分与几何：`tauE_used=2`、`Zeff=1.867`、`Vp=888.3`、`Sw=735.5`。
- 托卡马克 Tokamak 专属指标：`H98=7.438`、`H_ITPA20=8.873`、`betaN=30.09`、`q=2.12`、`q95=3.866`、`nbar_o_nGw=1.487`、`LH_ratio=28.96`。
- 当前点对默认 best 准则的逐项核对：`Pfus=8767` 满足 `>=10`；`Qfus=2.152` 满足 `>=1`；`nbar_o_nGw=1.487` 不满足 `<=1`；`Pheat=4075` 不满足 `<=100`。
