...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=32.58`、`Qfus=5.781`、`Pheat=5.636`、`Pwall=1.679`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=32.58`、`Qfus=5.781`、`Pheat=5.636`、`Pwall=1.679`、`Ptrans=12.06`、`Pbrem=0.09089`、`Pcycl=0.0009012`、`P_line=0`、`Pn=26.06`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.884`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.99`、`beta_avg=0.396`、`coll_ratio=1638`、`tau_Past=1.878`、`tauC_eff=637.2`。
- 当前点对默认 best 准则的逐项核对：`Pfus=32.58` 满足 `>=1`；`Qfus=5.781` 满足 `>=1`；`beta=0.99` 不满足 `<=0.6`。
