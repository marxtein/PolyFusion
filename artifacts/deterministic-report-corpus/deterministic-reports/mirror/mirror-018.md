...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=12.75`、`Qfus=125.8`、`Pheat=0.1014`、`Pwall=0.5647`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=12.75`、`Qfus=125.8`、`Pheat=0.1014`、`Pwall=0.5647`、`Ptrans=2.608`、`Pbrem=0.03623`、`Pcycl=0.007063`、`P_line=0`、`Pn=10.2`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.984`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.4068`、`beta_avg=0.1627`、`coll_ratio=1873`、`tau_Past=0.3668`、`tauC_eff=52.22`。
- 当前点对默认 best 准则的逐项核对：`Pfus=12.75` 满足 `>=1`；`Qfus=125.8` 满足 `>=1`；`beta=0.4068` 满足 `<=0.6`。
