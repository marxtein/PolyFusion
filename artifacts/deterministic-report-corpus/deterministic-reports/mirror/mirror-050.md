...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=13.07`、`Qfus=3.34`、`Pheat=3.914`、`Pwall=0.7463`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=13.07`、`Qfus=3.34`、`Pheat=3.914`、`Pwall=0.7463`、`Ptrans=6.493`、`Pbrem=0.03501`、`Pcycl=0.00071`、`P_line=0`、`Pn=10.46`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.884`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.99`、`beta_avg=0.396`、`coll_ratio=1955`、`tau_Past=2.461`、`tauC_eff=502`。
- 当前点对默认 best 准则的逐项核对：`Pfus=13.07` 满足 `>=1`；`Qfus=3.34` 满足 `>=1`；`beta=0.99` 不满足 `<=0.6`。
