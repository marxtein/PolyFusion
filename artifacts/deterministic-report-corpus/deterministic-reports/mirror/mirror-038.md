...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=164.1`、`Qfus=1000`、`Pheat=-16.89`、`Pwall=6.47`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=164.1`、`Qfus=1000`、`Pheat=-16.89`、`Pwall=6.47`、`Ptrans=15.52`、`Pbrem=0.4154`、`Pcycl=0.001318`、`P_line=0`、`Pn=131.3`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.884`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.99`、`beta_avg=0.396`、`coll_ratio=259.6`、`tau_Past=0.4237`、`tauC_eff=931.8`。
- 当前点对默认 best 准则的逐项核对：`Pfus=164.1` 满足 `>=1`；`Qfus=1000` 满足 `>=1`；`beta=0.99` 不满足 `<=0.6`。
