...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1.791`、`Qfus=0.5915`、`Pheat=3.028`、`Pwall=0.2118`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.791`、`Qfus=0.5915`、`Pheat=3.028`、`Pwall=0.2118`、`Ptrans=2.582`、`Pbrem=0.7892`、`Pcycl=0.01533`、`P_line=0`、`Pn=1.433`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.985`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.4027`、`beta_avg=0.1611`、`coll_ratio=2.731`、`tau_Past=1.757`、`tauC_eff=112.3`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.791` 满足 `>=1`；`Qfus=0.5915` 不满足 `>=1`；`beta=0.4027` 满足 `<=0.6`。
