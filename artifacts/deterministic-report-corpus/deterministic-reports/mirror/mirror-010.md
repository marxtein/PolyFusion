...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=8.136`、`Qfus=1000`、`Pheat=0.003374`、`Pwall=0.3576`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=8.136`、`Qfus=1000`、`Pheat=0.003374`、`Pwall=0.3576`、`Ptrans=1.586`、`Pbrem=0.03635`、`Pcycl=0.008314`、`P_line=0`、`Pn=6.509`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.994`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.2465`、`beta_avg=0.09861`、`coll_ratio=618.2`、`tau_Past=0.3766`、`tauC_eff=44.51`。
- 当前点对默认 best 准则的逐项核对：`Pfus=8.136` 满足 `>=1`；`Qfus=1000` 满足 `>=1`；`beta=0.2465` 满足 `<=0.6`。
