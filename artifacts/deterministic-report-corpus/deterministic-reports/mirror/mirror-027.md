...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=35.99`、`Qfus=1000`、`Pheat=-1.363`、`Pwall=1.521`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=35.99`、`Qfus=1000`、`Pheat=-1.363`、`Pwall=1.521`、`Ptrans=5.74`、`Pbrem=0.09216`、`Pcycl=0.002814`、`P_line=0`、`Pn=28.79`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.924`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.9136`、`beta_avg=0.3654`、`coll_ratio=944.4`、`tau_Past=0.4898`、`tauC_eff=206.9`。
- 当前点对默认 best 准则的逐项核对：`Pfus=35.99` 满足 `>=1`；`Qfus=1000` 满足 `>=1`；`beta=0.9136` 不满足 `<=0.6`。
