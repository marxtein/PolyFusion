...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2.122`、`Qfus=1.177`、`Pheat=1.802`、`Pwall=0.1724`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2.122`、`Qfus=1.177`、`Pheat=1.802`、`Pwall=0.1724`、`Ptrans=2.216`、`Pbrem=0.005487`、`Pcycl=0.004708`、`P_line=0`、`Pn=1.697`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.988`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.3452`、`beta_avg=0.1381`、`coll_ratio=2.858e+04`、`tau_Past=2.72`、`tauC_eff=30.51`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2.122` 满足 `>=1`；`Qfus=1.177` 满足 `>=1`；`beta=0.3452` 满足 `<=0.6`。
