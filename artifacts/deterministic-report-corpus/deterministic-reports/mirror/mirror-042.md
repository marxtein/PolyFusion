...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=13.76`、`Qfus=4.786`、`Pheat=2.875`、`Pwall=0.7309`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=13.76`、`Qfus=4.786`、`Pheat=2.875`、`Pwall=0.7309`、`Ptrans=5.589`、`Pbrem=0.03559`、`Pcycl=0.002567`、`P_line=0`、`Pn=11.01`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.931`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.8875`、`beta_avg=0.355`、`coll_ratio=4605`、`tau_Past=1.429`、`tauC_eff=141.1`。
- 当前点对默认 best 准则的逐项核对：`Pfus=13.76` 满足 `>=1`；`Qfus=4.786` 满足 `>=1`；`beta=0.8875` 不满足 `<=0.6`。
