...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=0.4079`、`Qfus=0.3031`、`Pheat=1.346`、`Pwall=0.07705`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=0.4079`、`Qfus=0.3031`、`Pheat=1.346`、`Pwall=0.07705`、`Ptrans=1.235`、`Pbrem=0.1797`、`Pcycl=0.01302`、`P_line=0`、`Pn=0.3263`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.997`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.1918`、`beta_avg=0.0767`、`coll_ratio=6.672`、`tau_Past=3.576`、`tauC_eff=63.25`。
- 当前点对默认 best 准则的逐项核对：`Pfus=0.4079` 不满足 `>=1`；`Qfus=0.3031` 不满足 `>=1`；`beta=0.1918` 满足 `<=0.6`。
