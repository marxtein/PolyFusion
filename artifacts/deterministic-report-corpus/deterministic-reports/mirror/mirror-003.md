...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=0.2146`、`Qfus=0.2237`、`Pheat=0.9592`、`Pwall=0.05157`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=0.2146`、`Qfus=0.2237`、`Pheat=0.9592`、`Pwall=0.05157`、`Ptrans=0.896`、`Pbrem=0.09453`、`Pcycl=0.01159`、`P_line=0`、`Pn=0.1717`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=3`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.139`、`beta_avg=0.05561`、`coll_ratio=9.498`、`tau_Past=4.9`、`tauC_eff=51.55`。
- 当前点对默认 best 准则的逐项核对：`Pfus=0.2146` 不满足 `>=1`；`Qfus=0.2237` 不满足 `>=1`；`beta=0.139` 满足 `<=0.6`。
