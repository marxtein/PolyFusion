...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=61.76`、`Qfus=1000`、`Pheat=-6.488`、`Pwall=2.428`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=61.76`、`Qfus=1000`、`Pheat=-6.488`、`Pwall=2.428`、`Ptrans=5.685`、`Pbrem=0.1755`、`Pcycl=0.003503`、`P_line=0`、`Pn=49.41`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.927`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.904`、`beta_avg=0.3616`、`coll_ratio=339.1`、`tau_Past=0.2237`、`tauC_eff=229.5`。
- 当前点对默认 best 准则的逐项核对：`Pfus=61.76` 满足 `>=1`；`Qfus=1000` 满足 `>=1`；`beta=0.904` 不满足 `<=0.6`。
