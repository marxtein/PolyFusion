...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1.354`、`Qfus=0.5235`、`Pheat=2.588`、`Pwall=0.1732`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.354`、`Qfus=0.5235`、`Pheat=2.588`、`Pwall=0.1732`、`Ptrans=2.247`、`Pbrem=0.5967`、`Pcycl=0.01513`、`P_line=0`、`Pn=1.084`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.988`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.3499`、`beta_avg=0.14`、`coll_ratio=3.279`、`tau_Past=2.004`、`tauC_eff=99`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.354` 满足 `>=1`；`Qfus=0.5235` 不满足 `>=1`；`beta=0.3499` 满足 `<=0.6`。
