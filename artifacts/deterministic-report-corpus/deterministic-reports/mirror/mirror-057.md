...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1.961`、`Qfus=0.7472`、`Pheat=2.625`、`Pwall=0.2015`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.961`、`Qfus=0.7472`、`Pheat=2.625`、`Pwall=0.2015`、`Ptrans=3.008`、`Pbrem=0.005472`、`Pcycl=0.004088`、`P_line=0`、`Pn=1.569`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.98`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.4698`、`beta_avg=0.1879`、`coll_ratio=4.941e+04`、`tau_Past=4.425`、`tauC_eff=35.04`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.961` 满足 `>=1`；`Qfus=0.7472` 不满足 `>=1`；`beta=0.4698` 满足 `<=0.6`。
