...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=35.91`、`Qfus=211`、`Pheat=0.1702`、`Pwall=1.585`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=35.91`、`Qfus=211`、`Pheat=0.1702`、`Pwall=1.585`、`Ptrans=7.261`、`Pbrem=0.09089`、`Pcycl=0.0009012`、`P_line=0`、`Pn=28.73`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.884`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.99`、`beta_avg=0.396`、`coll_ratio=555`、`tau_Past=0.9058`、`tauC_eff=637.2`。
- 当前点对默认 best 准则的逐项核对：`Pfus=35.91` 满足 `>=1`；`Qfus=211` 满足 `>=1`；`beta=0.99` 不满足 `<=0.6`。
