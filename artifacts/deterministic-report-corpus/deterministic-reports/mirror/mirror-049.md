...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2.046`、`Qfus=0.9242`、`Pheat=2.213`、`Pwall=0.1871`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2.046`、`Qfus=0.9242`、`Pheat=2.213`、`Pwall=0.1871`、`Ptrans=2.613`、`Pbrem=0.00548`、`Pcycl=0.004401`、`P_line=0`、`Pn=1.637`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.984`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.4075`、`beta_avg=0.163`、`coll_ratio=3.869e+04`、`tau_Past=3.524`、`tauC_eff=32.59`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2.046` 满足 `>=1`；`Qfus=0.9242` 不满足 `>=1`；`beta=0.4075` 满足 `<=0.6`。
