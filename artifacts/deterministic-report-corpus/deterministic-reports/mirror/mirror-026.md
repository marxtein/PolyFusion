...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=14.09`、`Qfus=16.69`、`Pheat=0.8447`、`Pwall=0.6563`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=14.09`、`Qfus=16.69`、`Pheat=0.8447`、`Pwall=0.6563`、`Ptrans=3.621`、`Pbrem=0.03609`、`Pcycl=0.005745`、`P_line=0`、`Pn=11.27`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.972`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.567`、`beta_avg=0.2268`、`coll_ratio=3405`、`tau_Past=0.6089`、`tauC_eff=63.95`。
- 当前点对默认 best 准则的逐项核对：`Pfus=14.09` 满足 `>=1`；`Qfus=16.69` 满足 `>=1`；`beta=0.567` 满足 `<=0.6`。
