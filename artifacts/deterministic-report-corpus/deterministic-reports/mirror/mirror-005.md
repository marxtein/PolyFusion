...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=0.6625`、`Qfus=0.3794`、`Pheat=1.746`、`Pwall=0.1058`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=0.6625`、`Qfus=0.3794`、`Pheat=1.746`、`Pwall=0.1058`、`Ptrans=1.573`、`Pbrem=0.2918`、`Pcycl=0.01402`、`P_line=0`、`Pn=0.53`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.994`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.2445`、`beta_avg=0.09779`、`coll_ratio=5.059`、`tau_Past=2.824`、`tauC_eff=74.79`。
- 当前点对默认 best 准则的逐项核对：`Pfus=0.6625` 不满足 `>=1`；`Qfus=0.3794` 不满足 `>=1`；`beta=0.2445` 满足 `<=0.6`。
