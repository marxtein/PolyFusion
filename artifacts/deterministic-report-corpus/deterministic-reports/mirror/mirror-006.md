...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=0.9781`、`Qfus=0.4528`、`Pheat=2.16`、`Pwall=0.1379`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=0.9781`、`Qfus=0.4528`、`Pheat=2.16`、`Pwall=0.1379`、`Ptrans=1.91`、`Pbrem=0.4309`、`Pcycl=0.01471`、`P_line=0`、`Pn=0.7825`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.991`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.2972`、`beta_avg=0.1189`、`coll_ratio=4.014`、`tau_Past=2.341`、`tauC_eff=86.59`。
- 当前点对默认 best 准则的逐项核对：`Pfus=0.9781` 不满足 `>=1`；`Qfus=0.4528` 不满足 `>=1`；`beta=0.2972` 满足 `<=0.6`。
