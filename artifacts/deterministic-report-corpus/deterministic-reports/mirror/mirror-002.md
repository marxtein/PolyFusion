...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=0.08275`、`Qfus=0.1412`、`Pheat=0.586`、`Pwall=0.02938`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=0.08275`、`Qfus=0.1412`、`Pheat=0.586`、`Pwall=0.02938`、`Ptrans=0.5566`、`Pbrem=0.03645`、`Pcycl=0.009522`、`P_line=0`、`Pn=0.0662`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=3.002`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.08629`、`beta_avg=0.03452`、`coll_ratio=15.76`、`tau_Past=7.845`、`tauC_eff=38.97`。
- 当前点对默认 best 准则的逐项核对：`Pfus=0.08275` 不满足 `>=1`；`Qfus=0.1412` 不满足 `>=1`；`beta=0.08629` 满足 `<=0.6`。
