...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=100.8`、`Qfus=75.26`、`Pheat=1.339`、`Pwall=4.486`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=100.8`、`Qfus=75.26`、`Pheat=1.339`、`Pwall=4.486`、`Ptrans=21.21`、`Pbrem=0.2811`、`Pcycl=0.001195`、`P_line=0`、`Pn=80.61`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.884`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.99`、`beta_avg=0.396`、`coll_ratio=931.3`、`tau_Past=1.068`、`tauC_eff=845.1`。
- 当前点对默认 best 准则的逐项核对：`Pfus=100.8` 满足 `>=1`；`Qfus=75.26` 满足 `>=1`；`beta=0.99` 不满足 `<=0.6`。
