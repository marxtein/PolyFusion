...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=14.18`、`Qfus=7.778`、`Pheat=1.824`、`Pwall=0.7033`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=14.18`、`Qfus=7.778`、`Pheat=1.824`、`Pwall=0.7033`、`Ptrans=4.62`、`Pbrem=0.0359`、`Pcycl=0.004304`、`P_line=0`、`Pn=11.35`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.957`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.7273`、`beta_avg=0.2909`、`coll_ratio=4670`、`tau_Past=0.9355`、`tauC_eff=84.91`。
- 当前点对默认 best 准则的逐项核对：`Pfus=14.18` 满足 `>=1`；`Qfus=7.778` 满足 `>=1`；`beta=0.7273` 不满足 `<=0.6`。
