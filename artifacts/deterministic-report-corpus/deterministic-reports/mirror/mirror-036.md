...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=68.32`、`Qfus=1000`、`Pheat=-3.476`、`Pwall=2.849`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=68.32`、`Qfus=1000`、`Pheat=-3.476`、`Pwall=2.849`、`Ptrans=10.01`、`Pbrem=0.1729`、`Pcycl=0.001058`、`P_line=0`、`Pn=54.66`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.884`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.99`、`beta_avg=0.396`、`coll_ratio=402.4`、`tau_Past=0.6567`、`tauC_eff=748.4`。
- 当前点对默认 best 准则的逐项核对：`Pfus=68.32` 满足 `>=1`；`Qfus=1000` 满足 `>=1`；`beta=0.99` 不满足 `<=0.6`。
