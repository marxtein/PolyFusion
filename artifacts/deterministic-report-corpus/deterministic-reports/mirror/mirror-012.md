...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=39.91`、`Qfus=1000`、`Pheat=-4.294`、`Pwall=1.565`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=39.91`、`Qfus=1000`、`Pheat=-4.294`、`Pwall=1.565`、`Ptrans=3.501`、`Pbrem=0.1783`、`Pcycl=0.008806`、`P_line=0`、`Pn=31.93`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.974`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.5479`、`beta_avg=0.2191`、`coll_ratio=215.5`、`tau_Past=0.1786`、`tauC_eff=92.76`。
- 当前点对默认 best 准则的逐项核对：`Pfus=39.91` 满足 `>=1`；`Qfus=1000` 满足 `>=1`；`beta=0.5479` 满足 `<=0.6`。
