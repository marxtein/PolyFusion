...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=12.55`、`Qfus=2.505`、`Pheat=5.011`、`Pwall=0.7716`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=12.55`、`Qfus=2.505`、`Pheat=5.011`、`Pwall=0.7716`、`Ptrans=7.486`、`Pbrem=0.03501`、`Pcycl=0.00071`、`P_line=0`、`Pn=10.04`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.884`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.99`、`beta_avg=0.396`、`coll_ratio=2639`、`tau_Past=3.025`、`tauC_eff=502`。
- 当前点对默认 best 准则的逐项核对：`Pfus=12.55` 满足 `>=1`；`Qfus=2.505` 满足 `>=1`；`beta=0.99` 不满足 `<=0.6`。
