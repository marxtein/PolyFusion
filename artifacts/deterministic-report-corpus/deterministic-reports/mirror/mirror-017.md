...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1.938`、`Qfus=3.014`、`Pheat=0.6428`、`Pwall=0.1134`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.938`、`Qfus=3.014`、`Pheat=0.6428`、`Pwall=0.1134`、`Ptrans=1.019`、`Pbrem=0.005506`、`Pcycl=0.005603`、`P_line=0`、`Pn=1.55`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.999`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.1582`、`beta_avg=0.06328`、`coll_ratio=5737`、`tau_Past=0.8788`、`tauC_eff=25.73`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.938` 满足 `>=1`；`Qfus=3.014` 满足 `>=1`；`beta=0.1582` 满足 `<=0.6`。
