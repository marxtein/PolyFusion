...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=33.93`、`Qfus=9.01`、`Pheat=3.766`、`Pwall=1.656`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=33.93`、`Qfus=9.01`、`Pheat=3.766`、`Pwall=1.656`、`Ptrans=10.46`、`Pbrem=0.09089`、`Pcycl=0.0009012`、`P_line=0`、`Pn=27.14`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.884`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.99`、`beta_avg=0.396`、`coll_ratio=1213`、`tau_Past=1.527`、`tauC_eff=637.2`。
- 当前点对默认 best 准则的逐项核对：`Pfus=33.93` 满足 `>=1`；`Qfus=9.01` 满足 `>=1`；`beta=0.99` 不满足 `<=0.6`。
