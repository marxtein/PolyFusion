...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=32.88`、`Qfus=1000`、`Pheat=-2.301`、`Pwall=1.343`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=32.88`、`Qfus=1000`、`Pheat=-2.301`、`Pwall=1.343`、`Ptrans=4.174`、`Pbrem=0.09342`、`Pcycl=0.00631`、`P_line=0`、`Pn=26.3`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.964`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.6554`、`beta_avg=0.2622`、`coll_ratio=886`、`tau_Past=0.2518`、`tauC_eff=93.55`。
- 当前点对默认 best 准则的逐项核对：`Pfus=32.88` 满足 `>=1`；`Qfus=1000` 满足 `>=1`；`beta=0.6554` 不满足 `<=0.6`。
