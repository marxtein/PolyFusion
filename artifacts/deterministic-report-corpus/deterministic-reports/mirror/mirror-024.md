...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=268.4`、`Qfus=1000`、`Pheat=-41.14`、`Pwall=9.983`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=268.4`、`Qfus=1000`、`Pheat=-41.14`、`Pwall=9.983`、`Ptrans=11.76`、`Pbrem=0.7625`、`Pcycl=0.001534`、`P_line=0`、`Pn=214.7`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.884`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.99`、`beta_avg=0.396`、`coll_ratio=52.11`、`tau_Past=0.1412`、`tauC_eff=1085`。
- 当前点对默认 best 准则的逐项核对：`Pfus=268.4` 满足 `>=1`；`Qfus=1000` 满足 `>=1`；`beta=0.99` 不满足 `<=0.6`。
