...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=111.1`、`Qfus=1000`、`Pheat=-9.162`、`Pwall=4.477`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=111.1`、`Qfus=1000`、`Pheat=-9.162`、`Pwall=4.477`、`Ptrans=12.77`、`Pbrem=0.2811`、`Pcycl=0.001195`、`P_line=0`、`Pn=88.85`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.884`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.99`、`beta_avg=0.396`、`coll_ratio=315.6`、`tau_Past=0.515`、`tauC_eff=845.1`。
- 当前点对默认 best 准则的逐项核对：`Pfus=111.1` 满足 `>=1`；`Qfus=1000` 满足 `>=1`；`beta=0.99` 不满足 `<=0.6`。
