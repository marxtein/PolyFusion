...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=64.57`、`Qfus=1000`、`Pheat=-8.176`、`Pwall=2.478`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=64.57`、`Qfus=1000`、`Pheat=-8.176`、`Pwall=2.478`、`Ptrans=4.442`、`Pbrem=0.2885`、`Pcycl=0.007703`、`P_line=0`、`Pn=51.66`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.96`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.6985`、`beta_avg=0.2794`、`coll_ratio=138`、`tau_Past=0.1459`、`tauC_eff=134.6`。
- 当前点对默认 best 准则的逐项核对：`Pfus=64.57` 满足 `>=1`；`Qfus=1000` 满足 `>=1`；`beta=0.6985` 不满足 `<=0.6`。
