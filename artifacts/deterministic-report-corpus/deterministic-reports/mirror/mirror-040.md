...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=301.3`、`Qfus=1000`、`Pheat=-38.46`、`Pwall=11.55`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=301.3`、`Qfus=1000`、`Pheat=-38.46`、`Pwall=11.55`、`Ptrans=21.03`、`Pbrem=0.7625`、`Pcycl=0.001534`、`P_line=0`、`Pn=241`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.884`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.99`、`beta_avg=0.396`、`coll_ratio=191.6`、`tau_Past=0.3127`、`tauC_eff=1085`。
- 当前点对默认 best 准则的逐项核对：`Pfus=301.3` 满足 `>=1`；`Qfus=1000` 满足 `>=1`；`beta=0.99` 不满足 `<=0.6`。
