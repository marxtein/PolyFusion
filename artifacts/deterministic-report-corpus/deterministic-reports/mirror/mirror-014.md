...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=94.75`、`Qfus=1000`、`Pheat=-13.16`、`Pwall=3.585`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=94.75`、`Qfus=1000`、`Pheat=-13.16`、`Pwall=3.585`、`Ptrans=5.362`、`Pbrem=0.4233`、`Pcycl=0.005629`、`P_line=0`、`Pn=75.8`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.939`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.8492`、`beta_avg=0.3397`、`coll_ratio=80.29`、`tau_Past=0.1285`、`tauC_eff=222.3`。
- 当前点对默认 best 准则的逐项核对：`Pfus=94.75` 满足 `>=1`；`Qfus=1000` 满足 `>=1`；`beta=0.8492` 不满足 `<=0.6`。
