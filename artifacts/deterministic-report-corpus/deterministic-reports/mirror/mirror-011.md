...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=21.06`、`Qfus=1000`、`Pheat=-1.56`、`Pwall=0.8565`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=21.06`、`Qfus=1000`、`Pheat=-1.56`、`Pwall=0.8565`、`Ptrans=2.547`、`Pbrem=0.09407`、`Pcycl=0.009062`、`P_line=0`、`Pn=16.84`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.985`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.3972`、`beta_avg=0.1589`、`coll_ratio=343.2`、`tau_Past=0.2392`、`tauC_eff=65.59`。
- 当前点对默认 best 准则的逐项核对：`Pfus=21.06` 满足 `>=1`；`Qfus=1000` 满足 `>=1`；`beta=0.3972` 满足 `<=0.6`。
