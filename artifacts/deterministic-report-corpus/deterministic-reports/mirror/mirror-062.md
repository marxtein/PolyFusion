...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=148.9`、`Qfus=1000`、`Pheat=-3.583`、`Pwall=6.385`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=148.9`、`Qfus=1000`、`Pheat=-3.583`、`Pwall=6.385`、`Ptrans=25.78`、`Pbrem=0.4154`、`Pcycl=0.001318`、`P_line=0`、`Pn=119.1`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.884`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.99`、`beta_avg=0.396`、`coll_ratio=766`、`tau_Past=0.8782`、`tauC_eff=931.8`。
- 当前点对默认 best 准则的逐项核对：`Pfus=148.9` 满足 `>=1`；`Qfus=1000` 满足 `>=1`；`beta=0.99` 不满足 `<=0.6`。
