...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2.148`、`Qfus=2.147`、`Pheat=1`、`Pwall=0.1383`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2.148`、`Qfus=2.147`、`Pheat=1`、`Pwall=0.1383`、`Ptrans=1.419`、`Pbrem=0.0055`、`Pcycl=0.005308`、`P_line=0`、`Pn=1.718`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.995`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.2205`、`beta_avg=0.08821`、`coll_ratio=1.175e+04`、`tau_Past=1.396`、`tauC_eff=27.12`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2.148` 满足 `>=1`；`Qfus=2.147` 满足 `>=1`；`beta=0.2205` 满足 `<=0.6`。
