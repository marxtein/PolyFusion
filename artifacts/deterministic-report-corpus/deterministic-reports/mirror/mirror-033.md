...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=2.171`、`Qfus=1.557`、`Pheat=1.395`、`Pwall=0.1566`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=2.171`、`Qfus=1.557`、`Pheat=1.395`、`Pwall=0.1566`、`Ptrans=1.818`、`Pbrem=0.005494`、`Pcycl=0.005011`、`P_line=0`、`Pn=1.737`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.992`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.2828`、`beta_avg=0.1131`、`coll_ratio=1.947e+04`、`tau_Past=2.012`、`tauC_eff=28.7`。
- 当前点对默认 best 准则的逐项核对：`Pfus=2.171` 满足 `>=1`；`Qfus=1.557` 满足 `>=1`；`beta=0.2828` 满足 `<=0.6`。
