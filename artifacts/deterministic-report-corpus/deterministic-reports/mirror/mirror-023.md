...
- 当前运行点：`valid=1`、`ignited=1`；`Pfus=202.7`、`Qfus=1000`、`Pheat=-29.74`、`Pwall=7.598`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=202.7`、`Qfus=1000`、`Pheat=-29.74`、`Pwall=7.598`、`Ptrans=10.22`、`Pbrem=0.5759`、`Pcycl=0.00143`、`P_line=0`、`Pn=162.1`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=2.884`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.99`、`beta_avg=0.396`、`coll_ratio=59.96`、`tau_Past=0.1625`、`tauC_eff=1011`。
- 当前点对默认 best 准则的逐项核对：`Pfus=202.7` 满足 `>=1`；`Qfus=1000` 满足 `>=1`；`beta=0.99` 不满足 `<=0.6`。
