...
- 当前运行点：`valid=1`、`ignited=0`；`Pfus=1.234`、`Qfus=3.221`、`Pheat=0.383`、`Pwall=0.07103`。
...
# 2. 关键指标解读
- 功率与损失：`Pfus=1.234`、`Qfus=3.221`、`Pheat=0.383`、`Pwall=0.07103`、`Ptrans=0.6184`、`Pbrem=0.005512`、`Pcycl=0.005894`、`P_line=0`、`Pn=0.9869`。
- 约束、成分与几何：`tau_E=1`、`Zeff=1`、`Vp=3.002`、`Sw=22.76`。
- 磁镜 Magnetic Mirror 专属指标：`beta=0.09588`、`beta_avg=0.03835`、`coll_ratio=1741`、`tau_Past=0.9501`、`tauC_eff=24.48`。
- 当前点对默认 best 准则的逐项核对：`Pfus=1.234` 满足 `>=1`；`Qfus=3.221` 满足 `>=1`；`beta=0.09588` 满足 `<=0.6`。
